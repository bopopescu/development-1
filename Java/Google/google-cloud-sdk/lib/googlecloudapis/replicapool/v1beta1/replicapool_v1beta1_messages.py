...
class Pool(messages.Message):
  ...
  Fields:
    ...
    type: The type of replica pool this is. Currently, only SMART_VM is
      supported to indicate Google Compute Engine virtual machine instances.
  """
...
class ReplicapoolReplicasRestartResponse(messages.Message):
  """An empty ReplicapoolReplicasRestart response."""
