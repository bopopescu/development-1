...
# Context for use with the API context parser.
COMPUTE_V1_API_CONTEXT = {
    'addresses': 'projects/{project}/regions/{region}/addresses/{address}',
    'disks': 'projects/{project}/zones/{zone}/disks/{disk}',
    'firewalls': 'projects/{project}/global/firewalls/{firewall}',
    'forwardingRules': ('projects/{project}/regions/{region}/forwardingRules/'
                        '{forwardingRule}'),
    'gateways': 'projects/{project}/global/gateways/{gateway}',
    'globalOperations': 'projects/{project}/global/operations/{operation}',
    'httpHealthChecks': ('projects/{project}/global/httpHealthChecks/'
                         '{httpHealthCheck}'),
    'images': 'projects/{project}/global/images/{image}',
    'instances': 'projects/{project}/zones/{zone}/instances/{instance}',
    'machineTypes': ('projects/{project}/zones/{zone}/machineTypes/'
                     '{machineType}'),
    'networks': 'projects/{project}/global/networks/{network}',
    'projects': 'projects/{project}',
    'regionOperations': ('projects/{project}/regions/{region}/operations/'
                         '{operation}'),
    'regions': 'projects/{project}/regions/{region}',
    'routes': 'projects/{project}/global/routes/{route}',
    'snapshots': 'projects/{project}/global/snapshots/{snapshot}',
    'targetInstances': ('projects/{project}/zones/{zone}/targetInstances/'
                        '{targetInstance}'),
    'targetPools': ('projects/{project}/regions/{region}/targetPools/'
                    '{targetPool}'),
    'zoneOperations': 'projects/{project}/zones/{zone}/operations/{operation}',
    'zones': 'projects/{project}/zones/{zone}',
}
