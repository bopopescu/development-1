...
class ResourceView(messages.Message):
  ...
  labels = messages.MessageField('Label', 4, repeated=True)
  lastModified = messages.StringField(5)
  members = messages.StringField(6, repeated=True)
  name = messages.StringField(7)
  numMembers = messages.IntegerField(8, variant=messages.Variant.UINT32)
