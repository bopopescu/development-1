...
class AttachedDisk(messages.Message):
  ...
  mode = messages.EnumField('ModeValueValuesEnum', 7)
  source = messages.StringField(8)
  type = messages.EnumField('TypeValueValuesEnum', 9)
...
class Disk(messages.Message):
  ...
  options = messages.StringField(6)
  selfLink = messages.StringField(7)
  sizeGb = messages.IntegerField(8)
  sourceImage = messages.StringField(9)
  sourceImageId = messages.StringField(10)
  sourceSnapshot = messages.StringField(11)
  sourceSnapshotId = messages.StringField(12)
  status = messages.EnumField('StatusValueValuesEnum', 13)
  type = messages.StringField(14)
  zone = messages.StringField(15)
...
class ForwardingRule(messages.Message):
  ...
  Fields:
    IPAddress: Value of the reserved IP address that this forwarding rule is
      serving on behalf of. The address resource must live in the same region
    ...
    region: URL of the region where the forwarding rule resides (output only).
    selfLink: Server defined URL for the resource (output only).
    target: The URL of the target resource to receive the matched traffic. It
      must live in the same region as this forwarding rule.
  """
...
class Image(messages.Message):
  ...
  name = messages.StringField(8)
  rawDisk = messages.MessageField('RawDiskValue', 9)
  selfLink = messages.StringField(10)
  sourceType = messages.EnumField('SourceTypeValueValuesEnum', 11, default=u'RAW')
...
class Snapshot(messages.Message):
  ...
  name = messages.StringField(6)
  selfLink = messages.StringField(7)
  sourceDisk = messages.StringField(8)
  sourceDiskId = messages.StringField(9)
  status = messages.EnumField('StatusValueValuesEnum', 10)
  storageBytes = messages.IntegerField(11)
  storageBytesStatus = messages.EnumField('StorageBytesStatusValueValuesEnum', 12)
