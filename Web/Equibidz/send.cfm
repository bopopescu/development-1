...
<cfif isdefined ("submit") and  #submit# is "Suggest a category">
...
<html>
 <head>
  <title>Suggest a Category</title>
...
<td>
    ...
    <tr><td><font size=4 color="000000"><b>Suggest a Category Page</b></font></td></tr>
    <tr><td><hr size=1 color=#heading_color# noshade></td></tr>
    <tr>
     <td>
     <font size=1><b>
Please enter <cfif isdefined("session.user_id") and session.user_id neq "" and isdefined("session.password") and session.password neq ""> your nickname, your password,</cfif> the category you 'd like to suggest, and click on "Suggest a Category" button.      
</b></font>
</td>
</tr>
<tr>
...
&nbsp;
 ...
 <br><br>
      	 ...
      	 <form name="send" action="send.cfm" method="post">
...
<tr>
       ...
       <td><textarea name="message" value="#message#" rows=5 cols=50 wrap=virtual></textarea></td>
        ...
        <input type="submit" name="submit" value="Suggest a Category" width=75>
       </form>
     </td>
    </tr>
