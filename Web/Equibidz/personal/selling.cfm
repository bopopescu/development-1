...
<cfset logOperator = "AND">
       ...
       <cfset field = "title">
        ...
        <cfloop index="l" list="#search_text#" delimiters=" ">
         ...
         <cfset sql_code = "WHERE #sql_code# AND user_id = #session.user_id#">
...
<TABLE width="100%" border=0>
  ...
  <TR>
    <TD><font size=4>Active Items</font></TD></TR></TABLE>



<TABLE height=48 width="100%" border=0>
  <form action="selling.cfm" method="get">
  <TR>
	...
	<tr><td colspan=8> <cfif getItems.recordcount gt countgroup>
	    <br>  Click here for more items: 
                <cfmodule template="../functions/pagelinks.cfm"
                  ...
                  link="#VAROOT#/personal/selling.cfm?user_id=#session.user_id#&status=#status#&limit_results=#limit_results#&search_text=#urlencodedformat(search_text)#">
	   </cfif></td></tr>
