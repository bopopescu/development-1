...
<body>
  ...
  <center>
   <table border=0 cellspacing=0 cellpadding=2 width=640>
	...
	<input type="submit" id="submit" name="Submit" value="Reset Defaults">
		</form></td>
		<td>&nbsp;</td>
		<td>
		<form action="logout_bulksell.cfm" method="post">
			<input type="submit" id="submit" name="logout_bulksell" value="Log out bulksell">
		</form>
		</td>
		</tr>
	</table>
     ...
     <td>
      ...
      <!--- variable set from previous page <tr>
       <td><font size=3 color="0000ff"><b>User ID or Nickname:</b></td>
       <td>&nbsp;</td>
       <td><input name="login" type="text" size=12 maxlength=20 value="#login#"></td>
      </tr>
      <tr>
       <td><font size=3 color="0000ff"><b>Password:</b></td>
       <td>&nbsp;</td>
       <td><input name="password" type="password" size=12 maxlength=12 value=""></td>
      </tr>
      <tr><td colspan=3><img src=#varoot#/images/spacer.gif height=8 width=2></td></tr> --->
    <cfif ListFindNoCase(defaultlist,"title")>
			<input type="Hidden" name="title" value="#title#">
			<input type="Hidden" name="bold_title" value="#Bold_title#">
		<cfelse>
       ...
       <td>&nbsp;</td>
       <td><table border=0 cellspacing=0 cellpadding=0><tr><td><input name="title" type="text" size=35 maxlength=75 <cfif #error_trap# is "yes">value="#title#"<cfelse>value=""</cfif>></td><td>&nbsp;<input name="bold_title" type="checkbox" value="1">&nbsp;Bold title<cfif #get_fee_bold.pair# GT 0> <font size=2>(a #DecimalFormat(get_fee_bold.pair)# #Trim(getCurrency.type)# fee)</font></cfif></td></tr></table></td>
      </tr>
		</cfif>
		<cfif ListFindNoCase(defaultlist,"banner")>
			<input type="Hidden" name="banner" value="#banner#">
      ...
      <tr>
       <td><b>Banner:</b></td>
       <td>&nbsp;</td>
       <td><table border=0 cellspacing=0 cellpadding=0><tr><td><input name="banner_line" type="text" size=35 maxlength=45 value=""></td><td>&nbsp;<input name="banner" type="checkbox" value="1">&nbsp;Enable banner<cfif #get_fee_banner.pair# GT 0> <font size=2>(a #DecimalFormat(get_fee_banner.pair)# #Trim(getCurrency.type)# fee)</font></cfif></td></tr></table></td>
      </tr>
		</cfif>
		<cfif ListFindNoCase(defaultlist,"quantity")>
			<input type="Hidden" name="quantity" value="#quantity#">
     ...
     <tr>
       ...
       <td colspan=2><textarea name="description" rows=5 cols=50 wrap=virtual><cfif #error_trap# is "yes">#description#</cfif></textarea></td>
		...
		<cfelse>
     <tr>
       <td nowrap><b>High estimate:</b></td>
       <td>&nbsp;</td>
     ...
     <tr>
      ...
      <tr>
       ...
       <td>&nbsp;</td>
       <td colspan=2><input name="location" type="text" size=35 maxlength=100 <cfif #error_trap# is "yes">value="#location#"<cfelse>value=""</cfif>></td>
      </tr>
		</cfif>
		<cfif ListFindNoCase(defaultlist,"country")>
				<input type="Hidden" name="country" value="#country#">
	...
	<input type="hidden" name="Endt_year_required" value="You must select a year when the auction ends.">	
      ...
      <tr>
       ...
       <td colspan=2 valign="top">
        ...
        <table border=0 cellspacing=0 cellpadding=0><tr><td>
			...
			<cfif ListFindNoCase(defaultlist,"category1") is 0>	
					</td><td><cfif #get_fee_second_cat.pair# GT 0><font size=2>(a #DecimalFormat(get_fee_second_cat.pair)# #Trim(getCurrency.type)# fee for 2nd category)</font><cfelse>&nbsp;</cfif></td></tr></table>
       </td>
      </tr>
     </cfif> 
	 ...
	 <input type="Hidden" name="Picture" value="#Picture_file#">
		...
		<cfelse>
      <tr>
        <td valign=top><b>Picture<br>source:</b></td>
        <td>&nbsp;</td>
        <td>
          <table border=0 cellspacing=0 cellpadding=0>
            <tr><td>
              <input name="Picture" type="file" size=43 maxlength=250><br>
              <font size=2><!--- A <cfif #get_fee_picture.pair# GT 0>#DecimalFormat(get_fee_picture.pair)# #Trim(getCurrency.type)#</cfif> fee for Picture inclusion. --->
		Only JPG  images are supported. </td></tr>
          </table>
        </td>
      </tr>     
		</cfif> --->
     ...
     <input name="sound_studio" type=hidden value="#sound_studio#">
      ...
      <tr>
       ...
       <td valign="top" colspan=2>
        <table border=0 cellspacing=0 cellpadding=1>
         <tr>
          <td><input name="pay_morder_ccheck" type="checkbox" value="1" <cfif #error_trap# is "yes" and #pay_morder_ccheck# is "1">checked</cfif>>&nbsp;Cashier's Check/Money Order</td>
          <td width=25>&nbsp;</td>
          <td><input name="pay_am_express" type="checkbox" value="1" <cfif #error_trap# is "yes" and #pay_am_express# is "1">checked</cfif>>&nbsp;American Express card</td>
         </tr>
         <tr>
          <td><input name="pay_cod" type="checkbox" value="1" <cfif #error_trap# is "yes" and #pay_cod# is "1">checked</cfif>>&nbsp;Collect-on-delivery (COD)</td>
          <td>&nbsp;</td>
          <td><input name="pay_discover" type="checkbox" value="1" <cfif #error_trap# is "yes" and #pay_discover# is "1">checked</cfif>>&nbsp;Discover card</td>
         </tr>
         <tr>
          <td><input name="pay_pcheck" type="checkbox" value="1" <cfif #error_trap# is "yes" and #pay_pcheck# is "1">checked</cfif>>&nbsp;Personal check</td>
          <td>&nbsp;</td>
          <td><input name="pay_ol_escrow" type="checkbox" value="1" <cfif #error_trap# is "yes" and #pay_ol_escrow# is "1">checked</cfif>>&nbsp;Online escrow</td>
         </tr>
         <tr>
          <td><input name="pay_visa_mc" type="checkbox" value="1" <cfif #error_trap# is "yes" and #pay_visa_mc# is "1">checked</cfif>>&nbsp;VISA/MasterCard</td>
          <td>&nbsp;</td>
          <td><input name="pay_other" type="checkbox" value="1" <cfif #error_trap# is "yes" and #pay_other# is "1">checked</cfif>>&nbsp;Other/Not listed here</td>
         </tr>
         <tr><td colspan=3><input name="pay_see_desc" type="checkbox" value="1" <cfif #error_trap# is "yes" and #pay_see_desc# is "1">checked</cfif>>&nbsp;See item description for payment information</td></tr>
        </table>
       </td>
      </tr>
      <tr>
      ...
      <tr>
       ...
       <td valign="top" colspan=2>
        <table border=0 cellspacing=0 cellpadding=1>
         <tr>
          <td><input name="ship_sell_pays" type="checkbox" value="1" <cfif #error_trap# is "yes" and #ship_sell_pays# is "1">checked</cfif>>&nbsp;Seller pays shipping costs</td>
         </tr>
         <tr>
          <td><input name="ship_buy_pays_act" type="checkbox" value="1" <cfif #error_trap# is "yes" and #ship_buy_pays_act# is "1">checked</cfif>>&nbsp;Buyer pays actual shipping costs</td>
         </tr>
         <tr>
          <td><input name="ship_buy_pays_fxd" type="checkbox" value="1" <cfif #error_trap# is "yes" and #ship_buy_pays_fxd# is "1">checked</cfif>>&nbsp;Buyer pays fixed shipping costs</td>
         </tr>
         <tr>
          <td><input name="ship_international" type="checkbox" value="1" <cfif #error_trap# is "yes" and #ship_international# is "1">checked</cfif>>&nbsp;Allow international shipping</td>
         </tr>
         <tr>
          <td><input name="ship_see_desc" type="checkbox" value="1" <cfif #error_trap# is "yes" and #ship_see_desc# is "1">checked</cfif>>&nbsp;See item description for shipping information</td>
         </tr>
        </table>
       </td>
      </tr>
    ...
    <tr>
      ...
      <td><b>&nbsp;</b></td>
      <td><input name="reserve_bid" type="text" size=7 maxlength=9 value="" onFocus="reverseItem()"> &nbsp; &nbsp;<b>(For single-quantity items only that are not reverse or buyer's auctions)</b></td>
    </tr>
	</cfif>
	<cfif ListFindNoCase(defaultlist,"buynow")>
				<input type="Hidden" name="buynow_price" value="#buynow_price#">
	...
	<!--- <cfif ListFindNoCase(defaultlist,"dynamic_valu")>
      ...
      <tr>
       ...
       <td>&nbsp;</td>
       <td valign=top><table border=0 cellspacing=0 cellpadding=0><tr><td><select name="dynamic_valu" size=1><cfloop query="get_dynamic"><option value="#pair#">#Int(pair)#</option></cfloop></select></td><td>&nbsp;</td><td><input type="checkbox" name="dynamic" value="1">&nbsp;Enabled</td></tr></table></td> 
      </tr>
		</cfif>
      <tr> --->
       <td colspan=4><img src=#varoot#/images/spacer.gif height=8 width=2></td>
      ...
      <tr>
       <td colspan="4" valign=top><b>Other Settings:</b></td>
      </tr>
		<cfif ListFindNoCase(defaultlist,"featured")>
				<input type="Hidden" name="featured" value="#featured#">
		<cfelse>
	       ...
	       <td>&nbsp;</td>
	       <td>&nbsp;</td>
		   	 <td colsppan="2"><input type="checkbox" name="featured" value="1">&nbsp;Feature this item on the front page<cfif #get_fee_featured.pair# GT 0> <font size=2>(a #DecimalFormat(get_fee_featured.pair)# #Trim(getCurrency.type)# fee)</font></cfif></td>
	     </tr>
		</cfif>
		<cfif ListFindNoCase(defaultlist,"featured_cat")>
					<input type="Hidden" name="featured_cat" value="#featured_cat#">
		<cfelse>
	       ...
	       <td>&nbsp;</td>
	       <td>&nbsp;</td>
		   	 <td colsppan="2"><input type="checkbox" name="featured_cat" value="1">&nbsp;Feature this item in its category(s)<cfif #get_fee_feat_cat.pair# GT 0> <font size=2>(a #DecimalFormat(REReplace(get_fee_feat_cat.pair, "[^0-9.]", "", "ALL"))# #Trim(getCurrency.type)# fee)</font></cfif></td>
	     </tr>
		</cfif>
		<!--- <cfif ListFindNoCase(defaultlist,"featured_studio")>
				<input type="Hidden" name="featured_studio" value="#featured_studio#">
		<cfelse> 
	       ...
	       <td>&nbsp;</td>
	       <td>&nbsp;</td>
		   	 <td colsppan="2"><input type="checkbox" name="featured_studio" value="1"  onClick="doThis()">&nbsp;Feature this item in Studio.<cfif #get_fee_feat_studio.pair# GT 0> <font size=2>(a #REReplace(get_fee_feat_studio.pair, "[^0-9.]", "", "ALL")# #Trim(getCurrency.type)# fee)</font></cfif></td>
	     </tr>
		</cfif> --->
		<cfif ListFindNoCase(defaultlist,"auto_relist")>
				<input type="Hidden" name="auto_relist" value="#auto_relist#">
      ...
      <tr>
       ...
       <td>&nbsp;</td>
	   <TD><INPUT TYPE="Text" NAME="auto_relist" VALUE="" SIZE="2" MAXLENGTH="1"> &nbsp;&nbsp;The number of times an item will automatically relist if it does not sell.</TD>
      </tr>
		</cfif>
		<cfif ListFindNoCase(defaultlist,"private")>
				<input type="Hidden" name="private" value="#private#">
      ...
      <tr>
       ...
       <td>&nbsp;</td>
       <td colspan=2>
	   <input type="checkbox" name="private" value="1">&nbsp;Auction is private (hide E-Mail addresses)</td> 
      </tr>
		</cfif>
		<!--- <cfif ListFindNoCase(defaultlist,"orig_cost")>
				<input type="Hidden" name="orig_cost" value="#orig_cost#">
      ...
      <tr>
       <td colspan=4><input type="submit" id="submit" name="submit_item" value="Add Item" width=75>&nbsp;&nbsp;&nbsp;<input type="reset" id="submit" value="Clear" width=75></td>
      </tr> 
     </table>
    </td>
   </tr>
      </form>
    <tr><td><br><br><img src=#varoot#/images/spacer.gif height=8 width=2></td></tr>
    <tr><td align="left"><cfinclude template="../../includes/copyrights.cfm"></td></tr>
    </form>
   </table>
   </center>
  <!---  <br>
  #defaultlist#<br> --->
	 <!---  #picdirectory##picserverfile#<br>
	#picdirectory##form.itemnum##right(picserverfile,4)#<br>
	Picincoming: #Picincoming#<br>
	Picdirectory: #Picdirectory#<br>
	Picserverfile:: #Picserverfile#<br> --->
	</cfoutput>
 </body>
</html>
