...
<!--- 			<cfset session.picture1 = form.picture1> --->
	...
	<cfif ListFindNoCase(form.defaultlist,"picture2")>
		<cflock timeout="15" throwontimeout="No" name="#session.sessionID#">
			<cfset session.picture2 = "">
		</cflock>
	</cfif>
	<cfif ListFindNoCase(form.defaultlist,"picture3")>
		<cflock timeout="15" throwontimeout="No" name="#session.sessionID#">
			<cfset session.picture3 = "">
		</cflock>
	</cfif>
	<cfif ListFindNoCase(form.defaultlist,"picture4")>
		<cflock timeout="15" throwontimeout="No" name="#session.sessionID#">
			<cfset session.picture4 = "">
		</cflock>
	</cfif>
...
<body>  
 ...
 <table border=0 cellspacing=0 cellpadding=2 width=640 align="center">
    <tr><td><center><cfoutput><FONT SIZE=2><cfinclude template="../../includes/menu_bar.cfm"></FONT></center></td></tr>
    <tr>
			<td>
				<cfif auction_mode is 0>
		 			<font size=4><b>Bulk Listing Page</b></font>
		...
		<tr><td><hr size=1 color=#heading_color#></td></tr>
    <tr>
     <td>
      <font size=3>
      ...
      <table border=0 cellspacing=0 cellpadding=2 width=100%>
       ...
       <td><font size=3 color="0000ff"><b>Title:</b></font></td>
			 <td>&nbsp;</td>
       <td><table border=0 cellspacing=0 cellpadding=0><tr valign="top" ><td><input name="title" type="text" size=35 maxlength=75 value="#title#"></td><td>&nbsp;<input name="bold_title" type="checkbox" value="1"><font size=3>&nbsp;Bold title<cfif #get_fee_bold.pair# GT 0> <font size=2>(a #numberFormat(get_fee_bold.pair,numbermask)# #Trim(getCurrency.type)# fee)</font></cfif></font></td></tr></table></td>
      </tr>
      <tr valign="top"  bgcolor="##D9D9D9">
       ...
       <td>&nbsp;</td>
       <td><table border=0 cellspacing=0 cellpadding=0><tr valign="top" ><td><input name="banner_line" type="text" size=35 maxlength=45 value="#banner_line#"></td><td>&nbsp;<input name="banner" type="checkbox" value="1"><font size=3>&nbsp;Enable banner<cfif #get_fee_banner.pair# GT 0> <font size=2>(a #numberFormat(get_fee_banner.pair,numbermask)# #Trim(getCurrency.type)# fee)</font></cfif></font></td></tr></table></td>
      </tr>
      <tr valign="top" >
     ...
     <tr valign="top"  bgcolor="##D9D9D9">
	  ...
	  <!--- <tr valign="top" >
       ...
       <td><font size=3><b>High estimate:</b></font></td>
       <td>&nbsp;</td>
   ...
   <!--- <cfset #End_time# = "#end_hour#:#end_min#">
	  ...
	  <tr valign="top">
       <td colspan=4><hr size=1 color=#heading_color#></td>
      </tr>
      <tr valign="top" >
      ...
      <tr valign="top"  bgcolor="##D9D9D9">
        ...
        <td>
          <table border=0 cellspacing=0 cellpadding=0>
            <tr valign="top" ><td> <FONT FACE="" SIZE="+1" COLOR="Red">Check box if <u>no </u> images are to be loaded for this set of auctions. </FONT><br>
              <font size=2>
		<!--- <br>Only JPG  images are supported.  ---></font>
	  ...
	  <tr valign="top" >
        ...
        <td valign=top><font size=3><b>Full Size<br>Image1:</b></font></td>
        <td>&nbsp;</td>
        <td>    <FONT FACE="" SIZE="+1" COLOR="Red">Check box if <u>no</u> full size images are to be loaded for this set of auctions. </FONT><br><cfif #get_fee_picture1.pair# GT 0> <font size=2>(a #numberFormat(get_fee_picture1.pair,numbermask)# #Trim(getCurrency.type)# fee for image1)</font></cfif>
	  ...
	  <tr valign="top" >
		<td valign="top"><input type="checkbox" name="defaultlist" value="picture2" <cfif ListFindNoCase(session.defaultlist,"picture2")> checked </cfif>></td>
        <td valign=top><font size=3><b>Full Size<br>Image2:</b></font></td>
        <td>&nbsp;</td>
        <td>    <FONT FACE="" SIZE="+1" COLOR="Red">Check box if <u>no</u> full size images are to be loaded for this set of auctions. </FONT><br><cfif #get_fee_picture2.pair# GT 0> <font size=2>(a #numberFormat(get_fee_picture2.pair,numbermask)# #Trim(getCurrency.type)# fee for image2)</font></cfif>
			
        </td>
      </tr>
	  <tr valign="top" >
		<td valign="top"><input type="checkbox" name="defaultlist" value="picture3" <cfif ListFindNoCase(session.defaultlist,"picture3")> checked </cfif>></td>
        <td valign=top><font size=3><b>Full Size<br>Image3:</b></font></td>
        <td>&nbsp;</td>
        <td>    <FONT FACE="" SIZE="+1" COLOR="Red">Check box if <u>no</u> full size images are to be loaded for this set of auctions. </FONT><br><cfif #get_fee_picture3.pair# GT 0> <font size=2>(a #numberFormat(get_fee_picture3.pair,numbermask)# #Trim(getCurrency.type)# fee for image3)</font></cfif>
			
        </td>
      </tr>
	  <tr valign="top" >
		<td valign="top"><input type="checkbox" name="defaultlist" value="picture4" <cfif ListFindNoCase(session.defaultlist,"picture4")> checked </cfif>></td>
        <td valign=top><font size=3><b>Full Size<br>Image4:</b></font></td>
        <td>&nbsp;</td>
        <td>    <FONT FACE="" SIZE="+1" COLOR="Red">Check box if <u>no</u> full size images are to be loaded for this set of auctions. </FONT><br><cfif #get_fee_picture4.pair# GT 0> <font size=2>(a #numberFormat(get_fee_picture4.pair,numbermask)# #Trim(getCurrency.type)# fee for image4)</font></cfif>
	  ...
	  <tr valign="top" >
        ...
        <td>&nbsp;</td>
        <td>    <FONT FACE="" SIZE="+1" COLOR="Red">Check box if <u>no</u> thumbnail images are to be loaded for this set of auctions. </FONT>
       ...
       <td valign="top" colspan=2>
        <table border=0 cellspacing=0 cellpadding=1>
         ...
         <tr>
          ...
          <td>&nbsp;</td>
          <td><input name="pay_ol_escrow" type="checkbox" value="1"<cfif #pay_ol_escrow# is "1"> checked</cfif>><font size=3>&nbsp;Online escrow</font></td>
         </tr>
         <tr>
	...
	<tr>
       ...
       <td>&nbsp;</td>
       <td valign=top><table border=0 cellspacing=0 cellpadding=0><tr><td><input type="text" name="buynow_price" size="7" value="#buynow_price#"></td><!--- <td align="left"><input type="checkbox" name="buynow" value="1"<cfif #buynow# is "1"> checked</cfif>><font size=3>&nbsp;<b>Enabled</b></font></td><td>&nbsp;</td> ---></tr></table></td> 
    </tr>
	<tr>
		<td colspan="3">&nbsp;</td>
    ...
    <tr valign="top" >
      ...
      <tr valign="top"  bgcolor="##D9D9D9">
       ...
       <td valign=top>
	   		<table border=0 cellspacing=0 cellpadding=0>
	   			<tr valign="top" >
					<td><select name="dynamic_valu" size=1><cfloop query="get_dynamic"><option value="#pair#"<cfif #dynamic_valu# is #pair#> selected</cfif>>#Int(pair)#</option></cfloop></select></td><td>&nbsp;</td><td><input type="checkbox" name="dynamic" value="1"<cfif #dynamic# is "1"> checked</cfif>><font size=3>&nbsp;Enabled</font></td>
				</tr>
			</table>
		</td> 
      </tr>
	...
	<br><input type="checkbox" name="featured_cat" value="1"<cfif #featured_cat# is "1"> checked</cfif>><font size=3>&nbsp;Feature this item in its category(s)<cfif #get_fee_feat_cat.pair# GT 0> <font size=2>(a #numberFormat(REReplace(get_fee_feat_cat.pair, "[^0-9.]", "", "ALL"),numbermask)# #Trim(getCurrency.type)# fee)</font></cfif></font>
	<!--- <br><input type="checkbox" name="featured_studio" value="1"<cfif #featured_studio# is "1">checked</cfif> onClick="doThis()"><font size=3>&nbsp;Feature this item in Studio.<cfif #get_fee_feat_studio.pair# GT 0> <font size=2>(a #numberFormat(REReplace(get_fee_feat_studio.pair, "[^0-9.]", "", "ALL"),numbermask)# #Trim(getCurrency.type)# fee)</font></cfif></font></td> --->
      </tr>
      ...
      <tr valign="top" >
       <td colspan=4><input type="submit" name="submit" value="Set bulk load defaults" width=75>&nbsp;&nbsp;&nbsp;<input type="reset" value="Clear" width=75></td>
      </tr> 
     </table>
    </td>
   </tr>
      </form>
    <tr valign="top" ><td><br><br><hr size=1 color=#heading_color#></td></tr>
    <tr valign="top" ><td align="left"><font size=3><cfinclude template="../../includes/copyrights.cfm"></font></td></tr>
    </form>
   </table>
   </center>
   <br>
