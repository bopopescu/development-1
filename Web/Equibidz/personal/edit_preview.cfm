...
<cfif isvalid>
  ...
  <cfif session.auction_type IS "E" OR session.auction_type IS "V">
    <cfset bidIncrement = IIf(session.increment, "session.increment_valu", "0.01")>
        ...
        <tr>
          <td>
            <font size=4>
              <b>
                <cfoutput>
                  <cfif isvalid><font size=3 color="0000ff"><center>This is how your item will be seen on the site:</center><br><br></font>#Trim(session.title)#<cfelse>Not Found</cfif>
                </cfoutput>
              </b>
            </font>
...
<!--- 
            <cfif isStudioImage>
              <cfoutput><br><img src="#studioPictureURL#"></cfoutput>
            </cfif>
 --->
            <cfif isImage>
...
<!--- 
            <cfif isStudioSound>
              <cfoutput><br><b>Sound:</b> <a href="#studioSoundURL#">#studioSoundURL#</a></cfoutput>
            </cfif>
 --->
            <cfif isSound>
        ...
        <tr>
         <td colspan=4>
          ...
          <table border=0 cellspacing=0 cellpadding=0>
           <tr>                       
            <td><form action="edit_info.cfm" method="post">
              <cfoutput>
            ...
            <td>&nbsp;</td>
            <td>
             <form action="edit_submit.cfm" method="post">
              <cfoutput>
               <input type="hidden" name="itemnum" value="#itemnum#">
               <input type="submit" name="submit" value="Continue" width=75>
              </cfoutput>
             </form>
            </td>            
