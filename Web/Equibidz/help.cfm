					...
					<tr>
						<td>
							<ol>
								...
								<b><li>User ID</b>
									<p class="p2">After you have registered and been approved for bidding, your User ID and Password will be confirmed by e-mail. Please remember your Password and User ID. Your Password and User ID are valid for all auctions on this web site.</font><p></li>
								<!---<b><li>Credit Cards</b>
								...
								<b><li>Bidding</b> 
									<p class="p2">Each auction has a starting bid posted. Some auctions may have a Buy Now option or a reserve price. You will be notified on the auctions page if the reserve or Buy Now has or has not been met. Bidding will be open during the time designated on the auction page. Enter your User ID and Password to submit your bid(s). NOTE: During the course of bidding you must REFRESH the page to make sure you are viewing the most current information.</font><p></li>
								<b><li>Bid Increments</b>
									<p class="p2">A bid increment is the minimum amount a bid must be raised. You must bid in these increments or enter a maximum bid amount.</font><p></li>
								<b><li>Maximum Bids</b>
								...
								<b><li>Ending the Auction</b>
									<p class="p2">Bidding will end on the date and time specified on each individual horse. If bids are received less than one minute apart within 10 minutes of closing time, bidding will be extended five minutes beyond the stated closing time. If a horse number is closed, no more bids will be taken. See horse numbers for exact closing times.</font><p></li>
								<b><li>Winning Bids</b>
									<p class="p2">Winning bidders will be sent a conformation e-mail with payment instructions. If you do not receive a conformation e-mail within 24 hours after the close of the auction please contact our office immediately. </font><p></li>
