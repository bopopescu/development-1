...
<!--- Start: Main Body --->
<table class="tbl-sidecolor"  width="#get_layout.page_width#" border="0" align="center" cellpadding="0" cellspacing="0">
<tr valign="top">
	<td align="center">
		<table width="#get_layout.page_width#" border="0" cellpadding="0" cellspacing="0">
		<tr>
			<td height="20"></td>
		</tr>
		<tr>
			<td>
             	<div class="main-menu">
                	...
                	<cfif isdefined("session.user_id") and session.user_id neq "" and isdefined("session.password") and session.password neq "">
					   ...
					   <cfinclude template="../includes/post_new_horse.cfm">
					<cfelse>
					   <span class="menu-item">
                ...
                <div class="bookmark">
					<!---<cfinclude template="adinfo_button2.cfm"> | --->
