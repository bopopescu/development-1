...
<!--- Menu --->
<!--- <cfif script_name contains ("Studio.cfm") is 0> ---><!---<form name="search" action="#VAROOT#/search/search_results.cfm" method="get" > </cfif> --->
<div align="center">
<table border="0" cellspacing="0" cellpadding="0">
<tr><td align=center><!--- <a href="#VAROOT#/index.cfm?hit=0"> ---><IMG SRC="#VAROOT#/logos/#get_layout.logo#" width=1003 border=0 alt="Auction Home"><!--- </a> ---></td></tr>
<!---<tr><td valign=top align=center #bg_color#>
<table width=100% border="0" cellspacing="0" cellpadding="3">
<tr><td align=left valign=middle> <cfif script_name contains ("Studio.cfm") is 0> --->&nbsp;&nbsp;&nbsp;
<!--- <B><font face=#get_layout.button_font# color=#get_layout.button_color#>Search</font></B> 
<input type=text name="search_text" size=50 maxlength="50" value=""><input type=submit name="search" value="Search"><A HREF="#VAROOT#/search/index.cfm"> &nbsp;&nbsp;<FONT id="ButtonText01" style="color:###get_layout.button_color#; position:relative;cursor:hand;" onmouseover="ColorOver01()" onmouseout="ColorOut01()"><b>Advanced Search</b></FONT></A> <input type="hidden" name="search_type" value="title_search"><input type="hidden" name="search_name" value="Title &amp Description Search"><input name="phrase_match" type=hidden value="any">---><!--- </cfif> --->
<!--- <cfif classified_valid IS "Yes"></td><td aligh=right><div align="right">
...
&nbsp;&nbsp;&nbsp;&nbsp;
<a href="#VAROOT#/classified/index.cfm" ><font id="ButtonText6" style="color:###get_layout.button_color#; position:relative;cursor:pointer;" align="right" onmouseover="ColorOver6()" onmouseout="ColorOut6()">Classified Ads</font></a>&nbsp;&nbsp;</div>
</CFIF>  
</td></tr>
</table>
</td>
...
<img src="/buttons/#listgetat(button_list,get_layout.button_style,",")#" style="position:absolute;left:0;top:0;width:100px;height:22px;" />
<a href="#VAROOT#/index.cfm"><div id="ButtonText1a" style="color:###get_layout.button_color#; position:relative;cursor:pointer;" align="center" onmouseover="ColorOver1a()" onmouseout="ColorOut1a()">Home</div></a></div>
</td>
<td valign=middle align=left width="98" height="29" #bg_color#>
<div style="position:relative;">
<img src="/buttons/#listgetat(button_list,get_layout.button_style,",")#" style="position:absolute;left:0;top:0;width:100px;height:22px;" />
<a  href="#VAROOT#/registration/index.cfm"><div id="ButtonText1" style="color:###get_layout.button_color#; position:relative;cursor:pointer;" align="center" onmouseover="ColorOver1()" onmouseout="ColorOut1()">Register</div></a></div>
</td>
<td valign=middle align=left  width="98" height="29" #bg_color#>
<div style="position:relative;">
<img src="/buttons/#listgetat(button_list,get_layout.button_style,",")#" style="position:absolute;left:0;top:0;width:100px;height:22px;" />
<a href="#VAROOT#/help/" ><div id="ButtonText3" style="color:###get_layout.button_color#; position:relative;cursor:pointer;" align="center" onmouseover="ColorOver3()" onmouseout="ColorOut3()">Help</div></a></div>
</td>
<td valign=middle align=left  width="98" height="29" #bg_color#>
<div style="position:relative;">
<img src="/buttons/#listgetat(button_list,get_layout.button_style,",")#" style="position:absolute;left:0;top:0;width:100px;height:22px;" />
<a href="#VAROOT#/messaging/" ><div id="ButtonText4" style="color:###get_layout.button_color#; position:relative;cursor:pointer;" align="center" onmouseover="ColorOver4()" onmouseout="ColorOut4()">Messaging</div></a></div>
</td>
<td valign=middle align=left  width="98" height="29" #bg_color#>
<div style="position:relative;">
<img src="/buttons/#listgetat(button_list,get_layout.button_style,",")#" style="position:absolute;left:0;top:0;width:100px;height:22px;" />
<a href="#VAROOT#/search/index.cfm"><div id="ButtonText5" style="color:###get_layout.button_color#; position:relative;cursor:pointer;" align="center" onmouseover="ColorOver5()" onmouseout="ColorOut5()">Search</div></a></div>
</td>
<td valign=middle align=left  width="98" height="29" #bg_color#>
<div style="position:relative;">
<img src="/buttons/#listgetat(button_list,get_layout.button_style,",")#" style="position:absolute;left:0;top:0;width:100px;height:22px;" />
<a href="#VAROOT#/help/sitemap.cfm" ><div id="ButtonText8" style="color:###get_layout.button_color#; position:relative;cursor:pointer;" align="center" onmouseover="ColorOver8()" onmouseout="ColorOut8()">Site&nbsp;Map</div></a></div>
</td>
<td valign=middle align=left  width="98" height="29" #bg_color#>
<div style="position:relative;">
<img src="/buttons/#listgetat(button_list,get_layout.button_style,",")#" style="position:absolute;left:0;top:0;width:100px;height:22px;" />
<a href="#VAROOT#/personal"><div id="ButtonText9" style="color:###get_layout.button_color#; position:relative;cursor:pointer;" align="center" onmouseover="ColorOver9()" onmouseout="ColorOut9()">My&nbsp;Account</div></a></div>
</td>
<td valign=middle align=left  width="98" height="29" #bg_color#>
<div style="position:relative;">
<img src="/buttons/#listgetat(button_list,get_layout.button_style,",")#" style="position:absolute;left:0;top:0;width:100px;height:22px;" />
<a href="#VAROOT#/listings/categories/index.cfm"><div id="ButtonText10" style="color:###get_layout.button_color#; position:relative;cursor:pointer;" align="center" onmouseover="ColorOver10()" onmouseout="ColorOut10()">Browse</div></a></div> 
</td>
<td valign=middle align=left  width="98" height="29" #bg_color#>&nbsp;
<!--- <div style="position:relative;">
<img src="/buttons/#listgetat(button_list,get_layout.button_style,",")#" style="position:absolute;left:0;top:0;width:100px;height:22px;" />
<a href="#VAROOT#/sellers/" ><div id="ButtonText2" style="color:###get_layout.button_color#; position:relative;cursor:pointer;" align="center" onmouseover="ColorOver2()" onmouseout="ColorOut2()">Sell</div></a></div> --->
</td>
<td valign=middle align=left  width="98" height="29" #bg_color#>&nbsp;
...
<font color=red>Logout</div></a></div> 
<cfelse>
<div style="position:relative;">
<img src="/buttons/#listgetat(button_list,get_layout.button_style,",")#" style="position:absolute;left:0;top:0;width:100px;height:22px;" />
...
</td> </tr></table><!--- </td></tr></table> ---></td></tr></table></div><!--- <cfif script_name contains ("Studio.cfm") is 0> ---><!--- </form></cfif> --->
</cfif>
