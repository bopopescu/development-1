...
<!--- Promotions Heading --->              <cfoutput>			  <table cellpadding=2 border=0 width="100%">                <tr>               <td WIDTH=100% style="color:#heading_fcolor#; font-family:#heading_font#;font-size:#heading_font_size#px;" align=center>
...
<TD align=center><BR>
<cfoutput><img src="#VAROOT#/logos/#get_layout.promotion_logo#" border=0><br>
<br></cfoutput>					</TD>				</TR>			</table>
