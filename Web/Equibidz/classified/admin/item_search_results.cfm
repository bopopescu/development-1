<html>
 <head>
  <title>Auction Server 3.0 Administrator [Auctions Module: Search Results]</title>
 </head>
 ...
 <!--- Do a search --->
 <cfquery name="search_items" datasource="#DATASOURCE#">
                    ...
                    <td>
                     ...
                     <select name="selected_item" size=10 width=260>
                      <cfloop query="search_items">
                       <cfoutput><option value="#itemnum#">#title#</option></cfoutput>
                      </cfloop>
                     </select>
                    </td>
                   </tr>
