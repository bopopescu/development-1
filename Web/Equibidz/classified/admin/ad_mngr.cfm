  ...
  <cfloop from="1" to="#lsize#" index="idx">
   ...
   <cfif #get_item_name.category# is "0">
    <cfif #lsize# is "1">
     <cfset #temp_name# = "[Top]">
    <cfelse>
     <cfset #temp_name# = "[<a href='#varoot#/admin/categories.cfm?selected_category=0&submit=top'>Top</a>]">
    </cfif>
   <cfelse>
   ...
   <cfif #idx# GT 1>
    ...
    <cfelse>
     <cfset #tree_path_str# = "#tree_path_str# > <a href='#varoot#/admin/
categories.cfm?selected_category=#trim(cur_cat_id)#&submit=expand'>#temp_name#</a>">
    </cfif>
   <cfelse>
    <cfif #idx# is #lsize#>
                 ...
                 <tr>
                  <cfoutput>
                   <cfif #cur_category# is "">
                    <td><table border=1 cellspacing=0 cellpadding=3 width=400><tr bgcolor="eeeeeef"><td><font face="helvetica" size=2 color=000080><b>Top</b></font></td></tr></table></td>
                   <cfelse>
                    <td><table border=1 cellspacing=0 cellpadding=3 width=100%><tr bgcolor="eeeeeef"><td><font face="helvetica" size=2 color=000080><b>#cur_category#</b> (#get_ad_items.recordCount# items)</font></td></tr></table></td>
                   </cfif>
                  </cfoutput>
                 </tr>
                 <tr>
                  <td width=400>
                   <select name="selected_item" size = 10 style="width:400px">
                    <cfif (#submit# is "Expand") or (#submit# is "Collapse")>
...
<cfif status eq 1>style="color:blue;font-weight:bold;" <cfelse> style="color:red;font-weight:bold;"</cfif>
value="#adnum#"<cfif (#adnum# is #selected_item#)> selected</cfif>>  #title#

<cfif status eq 1><font color=blue><b>(Active)</b></font><cfelse><font color=red><b>(Inactive)</cfif>
</b></font></option></cfoutput>
                       </cfloop>
                      <cfelse>
                       <cfloop query="get_ad_items">
                        <cfoutput><option value="#adnum#"   

<cfif #status# eq 1>style="color:blue;font-weight:bold;" <cfelse> style="color:red;font-weight:bold;"</cfif>
<cfif #currentRow# is 1> selected</cfif>>(#adnum#) #title#</option> <cfif status eq 1><font color=blue><b>(Active)</b></font><cfelse><font color=red><b>(Inactive)</cfif>
</b></font></cfoutput>
                       </cfloop>
                      </cfif>
                     </cfif>
...
<CFELSE>
Please make entries according to the example below.
