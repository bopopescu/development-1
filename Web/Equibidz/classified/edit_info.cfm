...
<cfsetting enablecfoutputonly="Yes">
 ...
 <cfinclude template="../includes/app_globals.cfm">
  ...
  <!--- def vals --->
  <cfset sDescAddendumNote = '<br><br><hr width=100% size=1 color="<cfoutput>#heading_color#</cfoutput>" noshade><font face="helvetica">On #DateFormat(Now(), "mm/dd/yyyy")# at #TimeFormat(Now(), "HH:mm:ss")#, advertiser added the following information:</font><br><br>'>
