                ...
                <td>
                 <table border=0 cellspacing=0 cellpadding=2>
                  ...
                  <tr>
                   ...
                   <td>&nbsp;</td>
                   <td><table border=0 cellspacing=0 cellpadding=0><tr><td><input name="title" type="text" size=35 maxlength=45 value="#session.title#"><!--- #session.title# ---> </td><td><!---(former bold title stuff)---></td></tr></table></td>
 <!---                 </tr>
				  <td><table border=0 cellspacing=0 cellpadding=0><tr><td><input name=</td></tr></table></td>
