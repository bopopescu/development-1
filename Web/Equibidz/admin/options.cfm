...
<cfif isdefined("submit") and trim(submit) eq "Apply">
<cfif isDefined('matching_bgcolor')>
<cfset matching_bgcolor = 1>
<cfelse>
<cfset matching_bgcolor = 0>
</cfif>

<cfquery name="updatebutton1" datasource="#datasource#">
update layout set button_style = '#form.buttonnumber#', button_font='#form.ffamily#',button_size='#form.fsize#',button_color='#form.fcolor#',button_hover='#form.fmouseover#', matching_bgcolor = #matching_bgcolor#
</cfquery>

<!--- Test Layout Column Output 
<!---
none .............. 0
map ............... 1
categories ........ 2
...
<!--- ********************** First Column *********************** --->
<cfif #form.col1sec1# eq "none">
<cfset col1sec1_number=0>
<cfset col1sec1_image="layoutimages/no_section.gif">
</cfif>
<cfif #form.col1sec1# eq "map">
<cfset col1sec1_number=1>
<cfset col1sec1_image="layoutimages/map_section.gif">
</cfif>
<cfif #form.col1sec1# eq "categories">
<cfset col1sec1_number=2>
<cfset col1sec1_image="layoutimages/categories_section.gif">
</cfif>
<cfif #form.col1sec1# eq "tellafriend">
<cfset col1sec1_number=3>
<cfset col1sec1_image="layoutimages/tellafriend_section.gif">
</cfif>
<cfif #form.col1sec1# eq "gallery">
<cfset col1sec1_number=4>
<cfset col1sec1_image="layoutimages/gallery_section.gif">
</cfif>
<cfif #form.col1sec1# eq "featured">
<cfset col1sec1_number=5>
<cfset col1sec1_image="layoutimages/featured_section.gif">
</cfif>
<cfif #form.col1sec1# eq "hot">
<cfset col1sec1_number=6>
<cfset col1sec1_image="layoutimages/hot_section.gif">
</cfif>
<cfif #form.col1sec1# eq "loginsection">
<cfset col1sec1_number=7>
<cfset col1sec1_image="layoutimages/login_section.gif">
</cfif>
<cfif #form.col1sec1# eq "promotions">
<cfset col1sec1_number=8>
<cfset col1sec1_image="layoutimages/promotions_section.gif">
</cfif>
<cfif #form.col1sec1# eq "newusers">
<cfset col1sec1_number=9>
<cfset col1sec1_image="layoutimages/newusers_section.gif">
</cfif>
<cfif #form.col1sec1# eq "imageonly">
<cfset col1sec1_number=10>
<cfset col1sec1_image="layoutimages/imageonly.gif">
</cfif>
<!--- ********************** End - Store Column/Section Info *********************** --->
<!--- ********************** Start - Store Column/Section Info *********************** --->
<cfif #form.col1sec2# eq "none">
<cfset col1sec2_number=0>
<cfset col1sec2_image="layoutimages/no_section.gif">
</cfif>
<cfif #form.col1sec2# eq "map">
<cfset col1sec2_number=1>
<cfset col1sec2_image="layoutimages/map_section.gif">
</cfif>
<cfif #form.col1sec2# eq "categories">
<cfset col1sec2_number=2>
<cfset col1sec2_image="layoutimages/categories_section.gif">
</cfif>
<cfif #form.col1sec2# eq "tellafriend">
<cfset col1sec2_number=3>
<cfset col1sec2_image="layoutimages/tellafriend_section.gif">
</cfif>
<cfif #form.col1sec2# eq "gallery">
<cfset col1sec2_number=4>
<cfset col1sec2_image="layoutimages/gallery_section.gif">
</cfif>
<cfif #form.col1sec2# eq "featured">
<cfset col1sec2_number=5>
<cfset col1sec2_image="layoutimages/featured_section.gif">
</cfif>
<cfif #form.col1sec2# eq "hot">
<cfset col1sec2_number=6>
<cfset col1sec2_image="layoutimages/hot_section.gif">
</cfif>
<cfif #form.col1sec2# eq "loginsection">
<cfset col1sec2_number=7>
<cfset col1sec2_image="layoutimages/login_section.gif">
</cfif>
<cfif #form.col1sec2# eq "promotions">
<cfset col1sec2_number=8>
<cfset col1sec2_image="layoutimages/promotions_section.gif">
</cfif>
<cfif #form.col1sec2# eq "newusers">
<cfset col1sec2_number=9>
<cfset col1sec2_image="layoutimages/newusers_section.gif">
</cfif>
<cfif #form.col1sec2# eq "imageonly">
<cfset col1sec2_number=10>
<cfset col1sec2_image="layoutimages/imageonly.gif">
</cfif>
<!--- ********************** End - Store Column/Section Info *********************** --->
<!--- ********************** Start - Store Column/Section Info *********************** --->
<cfif #form.col1sec3# eq "none">
<cfset col1sec3_number=0>
<cfset col1sec3_image="layoutimages/no_section.gif">
</cfif>
<cfif #form.col1sec3# eq "map">
<cfset col1sec3_number=1>
<cfset col1sec3_image="layoutimages/map_section.gif">
</cfif>
<cfif #form.col1sec3# eq "categories">
<cfset col1sec3_number=2>
<cfset col1sec3_image="layoutimages/categories_section.gif">
</cfif>
<cfif #form.col1sec3# eq "tellafriend">
<cfset col1sec3_number=3>
<cfset col1sec3_image="layoutimages/tellafriend_section.gif">
</cfif>
<cfif #form.col1sec3# eq "gallery">
<cfset col1sec3_number=4>
<cfset col1sec3_image="layoutimages/gallery_section.gif">
</cfif>
<cfif #form.col1sec3# eq "featured">
<cfset col1sec3_number=5>
<cfset col1sec3_image="layoutimages/featured_section.gif">
</cfif>
<cfif #form.col1sec3# eq "hot">
<cfset col1sec3_number=6>
<cfset col1sec3_image="layoutimages/hot_section.gif">
</cfif>
<cfif #form.col1sec3# eq "loginsection">
<cfset col1sec3_number=7>
<cfset col1sec3_image="layoutimages/login_section.gif">
</cfif>
<cfif #form.col1sec3# eq "promotions">
<cfset col1sec3_number=8>
<cfset col1sec3_image="layoutimages/promotions_section.gif">
</cfif>
<cfif #form.col1sec3# eq "newusers">
<cfset col1sec3_number=9>
<cfset col1sec3_image="layoutimages/newusers_section.gif">
</cfif>
<cfif #form.col1sec3# eq "imageonly">
<cfset col1sec3_number=10>
<cfset col1sec3_image="layoutimages/imageonly.gif">
</cfif>
<!--- ********************** End - Store Column/Section Info *********************** --->

<!--- ********************** Start Second Column *********************** --->
<cfif #form.col2sec1# eq "none">
<cfset col2sec1_number=0>
<cfset col2sec1_image="layoutimages/no_section.gif">
</cfif>
<cfif #form.col2sec1# eq "map">
<cfset col2sec1_number=1>
<cfset col2sec1_image="layoutimages/map_section.gif">
</cfif>
<cfif #form.col2sec1# eq "categories">
<cfset col2sec1_number=2>
<cfset col2sec1_image="layoutimages/categories_section.gif">
</cfif>
<cfif #form.col2sec1# eq "tellafriend">
<cfset col2sec1_number=3>
<cfset col2sec1_image="layoutimages/tellafriend_section.gif">
</cfif>
<cfif #form.col2sec1# eq "gallery">
<cfset col2sec1_number=4>
<cfset col2sec1_image="layoutimages/gallery_section.gif">
</cfif>
<cfif #form.col2sec1# eq "featured">
<cfset col2sec1_number=5>
<cfset col2sec1_image="layoutimages/featured_section.gif">
</cfif>
<cfif #form.col2sec1# eq "hot">
<cfset col2sec1_number=6>
<cfset col2sec1_image="layoutimages/hot_section.gif">
</cfif>
<cfif #form.col2sec1# eq "loginsection">
<cfset col2sec1_number=7>
<cfset col2sec1_image="layoutimages/login_section.gif">
</cfif>
<cfif #form.col2sec1# eq "promotions">
<cfset col2sec1_number=8>
<cfset col2sec1_image="layoutimages/promotions_section.gif">
</cfif>
<cfif #form.col2sec1# eq "newusers">
<cfset col2sec1_number=9>
<cfset col2sec1_image="layoutimages/newusers_section.gif">
</cfif>
<cfif #form.col2sec1# eq "imageonly">
<cfset col2sec1_number=10>
<cfset col2sec1_image="layoutimages/imageonly.gif">
</cfif>
<!--- ********************** End - Store Column/Section Info *********************** --->
<!--- ********************** Start - Store Column/Section Info *********************** --->
<cfif #form.col2sec2# eq "none">
<cfset col2sec2_number=0>
<cfset col2sec2_image="layoutimages/no_section.gif">
</cfif>
<cfif #form.col2sec2# eq "map">
<cfset col2sec2_number=1>
<cfset col2sec2_image="layoutimages/map_section.gif">
</cfif>
<cfif #form.col2sec2# eq "categories">
<cfset col2sec2_number=2>
<cfset col2sec2_image="layoutimages/categories_section.gif">
</cfif>
<cfif #form.col2sec2# eq "tellafriend">
<cfset col2sec2_number=3>
<cfset col2sec2_image="layoutimages/tellafriend_section.gif">
</cfif>
<cfif #form.col2sec2# eq "gallery">
<cfset col2sec2_number=4>
<cfset col2sec2_image="layoutimages/gallery_section.gif">
</cfif>
<cfif #form.col2sec2# eq "featured">
<cfset col2sec2_number=5>
<cfset col2sec2_image="layoutimages/featured_section.gif">
</cfif>
<cfif #form.col2sec2# eq "hot">
<cfset col2sec2_number=6>
<cfset col2sec2_image="layoutimages/hot_section.gif">
</cfif>
<cfif #form.col2sec2# eq "loginsection">
<cfset col2sec2_number=7>
<cfset col2sec2_image="layoutimages/login_section.gif">
</cfif>
<cfif #form.col2sec2# eq "promotions">
<cfset col2sec2_number=8>
<cfset col2sec2_image="layoutimages/promotions_section.gif">
</cfif>
<cfif #form.col2sec2# eq "newusers">
<cfset col2sec2_number=9>
<cfset col2sec2_image="layoutimages/newusers_section.gif">
</cfif>
<cfif #form.col2sec2# eq "imageonly">
<cfset col2sec2_number=10>
<cfset col2sec2_image="layoutimages/imageonly.gif">
</cfif>
<!--- ********************** End - Store Column/Section Info *********************** --->
<!--- ********************** Start - Store Column/Section Info *********************** --->
<cfif #form.col2sec3# eq "none">
<cfset col2sec3_number=0>
<cfset col2sec3_image="layoutimages/no_section.gif">
</cfif>
<cfif #form.col2sec3# eq "map">
<cfset col2sec3_number=1>
<cfset col2sec3_image="layoutimages/map_section.gif">
</cfif>
<cfif #form.col2sec3# eq "categories">
<cfset col2sec3_number=2>
<cfset col2sec3_image="layoutimages/categories_section.gif">
</cfif>
<cfif #form.col2sec3# eq "tellafriend">
<cfset col2sec3_number=3>
<cfset col2sec3_image="layoutimages/tellafriend_section.gif">
</cfif>
<cfif #form.col2sec3# eq "gallery">
<cfset col2sec3_number=4>
<cfset col2sec3_image="layoutimages/gallery_section.gif">
</cfif>
<cfif #form.col2sec3# eq "featured">
<cfset col2sec3_number=5>
<cfset col2sec3_image="layoutimages/featured_section.gif">
</cfif>
<cfif #form.col2sec3# eq "hot">
<cfset col2sec3_number=6>
<cfset col2sec3_image="layoutimages/hot_section.gif">
</cfif>
<cfif #form.col2sec3# eq "loginsection">
<cfset col2sec3_number=7>
<cfset col2sec3_image="layoutimages/login_section.gif">
</cfif>
<cfif #form.col2sec3# eq "promotions">
<cfset col2sec3_number=8>
<cfset col2sec3_image="layoutimages/promotions_section.gif">
</cfif>
<cfif #form.col2sec3# eq "newusers">
<cfset col2sec3_number=9>
<cfset col2sec3_image="layoutimages/newusers_section.gif">
</cfif>
<cfif #form.col2sec3# eq "imageonly">
<cfset col2sec3_number=10>
<cfset col2sec3_image="layoutimages/imageonly.gif">
</cfif>
<!--- ********************** End - Store Column/Section Info *********************** --->

<!--- ********************** Start Third Column *********************** --->
<cfif #form.col3sec1# eq "none">
<cfset col3sec1_number=0>
<cfset col3sec1_image="layoutimages/no_section.gif">
</cfif>
<cfif #form.col3sec1# eq "map">
<cfset col3sec1_number=1>
<cfset col3sec1_image="layoutimages/map_section.gif">
</cfif>
<cfif #form.col3sec1# eq "categories">
<cfset col3sec1_number=2>
<cfset col3sec1_image="layoutimages/categories_section.gif">
</cfif>
<cfif #form.col3sec1# eq "tellafriend">
<cfset col3sec1_number=3>
<cfset col3sec1_image="layoutimages/tellafriend_section.gif">
</cfif>
<cfif #form.col3sec1# eq "gallery">
<cfset col3sec1_number=4>
<cfset col3sec1_image="layoutimages/gallery_section.gif">
</cfif>
<cfif #form.col3sec1# eq "featured">
<cfset col3sec1_number=5>
<cfset col3sec1_image="layoutimages/featured_section.gif">
</cfif>
<cfif #form.col3sec1# eq "hot">
<cfset col3sec1_number=6>
<cfset col3sec1_image="layoutimages/hot_section.gif">
</cfif>
<cfif #form.col3sec1# eq "loginsection">
<cfset col3sec1_number=7>
<cfset col3sec1_image="layoutimages/login_section.gif">
</cfif>
<cfif #form.col3sec1# eq "promotions">
<cfset col3sec1_number=8>
<cfset col3sec1_image="layoutimages/promotions_section.gif">
</cfif>
<cfif #form.col3sec1# eq "newusers">
<cfset col3sec1_number=9>
<cfset col3sec1_image="layoutimages/newusers_section.gif">
</cfif>
<cfif #form.col3sec1# eq "imageonly">
<cfset col3sec1_number=10>
<cfset col3sec1_image="layoutimages/imageonly.gif">
</cfif>
<!--- ********************** End - Store Column/Section Info *********************** --->
<!--- ********************** Start - Store Column/Section Info *********************** --->
<cfif #form.col3sec2# eq "none">
<cfset col3sec2_number=0>
<cfset col3sec2_image="layoutimages/no_section.gif">
</cfif>
<cfif #form.col3sec2# eq "map">
<cfset col3sec2_number=1>
<cfset col3sec2_image="layoutimages/map_section.gif">
</cfif>
<cfif #form.col3sec2# eq "categories">
<cfset col3sec2_number=2>
<cfset col3sec2_image="layoutimages/categories_section.gif">
</cfif>
<cfif #form.col3sec2# eq "tellafriend">
<cfset col3sec2_number=3>
<cfset col3sec2_image="layoutimages/tellafriend_section.gif">
</cfif>
<cfif #form.col3sec2# eq "gallery">
<cfset col3sec2_number=4>
<cfset col3sec2_image="layoutimages/gallery_section.gif">
</cfif>
<cfif #form.col3sec2# eq "featured">
<cfset col3sec2_number=5>
<cfset col3sec2_image="layoutimages/featured_section.gif">
</cfif>
<cfif #form.col3sec2# eq "hot">
<cfset col3sec2_number=6>
<cfset col3sec2_image="layoutimages/hot_section.gif">
</cfif>
<cfif #form.col3sec2# eq "loginsection">
<cfset col3sec2_number=7>
<cfset col3sec2_image="layoutimages/login_section.gif">
</cfif>
<cfif #form.col3sec2# eq "promotions">
<cfset col3sec2_number=8>
<cfset col3sec2_image="layoutimages/promotions_section.gif">
</cfif>
<cfif #form.col3sec2# eq "newusers">
<cfset col3sec2_number=9>
<cfset col3sec2_image="layoutimages/newusers_section.gif">
</cfif>
<cfif #form.col3sec2# eq "imageonly">
<cfset col3sec2_number=10>
<cfset col3sec2_image="layoutimages/imageonly.gif">
</cfif>
<!--- ********************** End - Store Column/Section Info *********************** --->
<!--- ********************** Start - Store Column/Section Info *********************** --->
<cfif #form.col3sec3# eq "none">
<cfset col3sec3_number=0>
<cfset col3sec3_image="layoutimages/no_section.gif">
</cfif>
<cfif #form.col3sec3# eq "map">
<cfset col3sec3_number=1>
<cfset col3sec3_image="layoutimages/map_section.gif">
</cfif>
<cfif #form.col3sec3# eq "categories">
<cfset col3sec3_number=2>
<cfset col3sec3_image="layoutimages/categories_section.gif">
</cfif>
<cfif #form.col3sec3# eq "tellafriend">
<cfset col3sec3_number=3>
<cfset col3sec3_image="layoutimages/tellafriend_section.gif">
</cfif>
<cfif #form.col3sec3# eq "gallery">
<cfset col3sec3_number=4>
<cfset col3sec3_image="layoutimages/gallery_section.gif">
</cfif>
<cfif #form.col3sec3# eq "featured">
<cfset col3sec3_number=5>
<cfset col3sec3_image="layoutimages/featured_section.gif">
</cfif>
<cfif #form.col3sec3# eq "hot">
<cfset col3sec3_number=6>
<cfset col3sec3_image="layoutimages/hot_section.gif">
</cfif>
<cfif #form.col3sec3# eq "loginsection">
<cfset col3sec3_number=7>
<cfset col3sec3_image="layoutimages/login_section.gif">
</cfif>
<cfif #form.col3sec3# eq "promotions">
<cfset col3sec3_number=8>
<cfset col3sec3_image="layoutimages/promotions_section.gif">
</cfif>
<cfif #form.col3sec3# eq "newusers">
<cfset col3sec3_number=9>
<cfset col3sec3_image="layoutimages/newusers_section.gif">
</cfif>
<cfif #form.col3sec3# eq "imageonly">
<cfset col3sec3_number=10>
<cfset col3sec3_image="layoutimages/imageonly.gif">
</cfif>
<!--- ********************** End - Store Column/Section Info *********************** --->

<!--- Update Layout Query --->
<cfquery name="updatelayout" datasource="#datasource#">
update layout set col1sec1=#col1sec1_number#,col1sec2=#col1sec2_number#,col1sec3=#col1sec3_number#,col2sec1=#col2sec1_number#,col2sec2=#col2sec2_number#,col2sec3=#col2sec3_number#,col3sec1=#col3sec1_number#,col3sec2=#col3sec2_number#,col3sec3=#col3sec3_number#,sectionimage1='#col1sec1_image#',sectionimage2='#col1sec2_image#',sectionimage3='#col1sec3_image#',sectionimage4='#col2sec1_image#',sectionimage5='#col2sec2_image#',sectionimage6='#col2sec3_image#',sectionimage7='#col3sec1_image#',sectionimage8='#col3sec2_image#',sectionimage9='#col3sec3_image#'
</cfquery>
  ...
  <cfif #isDefined ("submit")#>
    ...
    <cfif #trim(submit)# is "Apply">
      ...
      <cfif #set_link_color# is "custom">
	  	<cfif trim(custom_link_color) eq "">
			<cfset error_message = error_message & "<font color='Red'>Please enter custom color code for link.  </font>">
		</cfif>
       <cfset set_link_color = "#custom_link_color#"> 
      </cfif>
      <cfif #set_vlink_color# is "custom">
	  	<cfif trim(custom_vlink_color) eq "">
			<cfset error_message = error_message & "<font color='Red'>Please enter custom color code for visited link.  </font>">
		</cfif>
         <cfset set_vlink_color = "#custom_vlink_color#"> 
      </cfif>
      <cfif #set_alink_color# is "custom">
	  	<cfif trim(custom_alink_color) eq "">
			<cfset error_message = error_message & "<font color='Red'>Please enter custom color code for active link.  </font>">
		</cfif>
        <cfset set_alink_color = "#custom_alink_color#"> 
      </cfif>
	  
	   <cfif #set_hlink_color# is "custom">
	  	<cfif trim(custom_hlink_color) eq "">
			<cfset error_message = error_message & "<font color='Red'>Please enter custom color code for a hovered link.  </font>">
		</cfif>
      <cfset set_hlink_color = "#custom_hlink_color#"> 
      </cfif>
	  
      <cfif #set_text_color# is "custom">
	  	<cfif trim(custom_text_color) eq "">
			<cfset error_message = error_message & "<font color='Red'>Please enter custom color code for page text.  </font>">
		</cfif>
       <cfset set_text_color = "#custom_text_color#"> 
      </cfif>
	  <cfif form.set_text_font eq "">
			<cfset error_message = error_message & "<font color='Red'>Please enter font for the default text.  </font>">
		</cfif>
      <cfif #set_bg_color# is "custom">
	  	<cfif trim(custom_bg_color) eq "">
			<cfset error_message = error_message & "<font color='Red'>Please enter custom color code for background.  </font>">
		</cfif>
      <cfset set_bg_color = "#custom_bg_color#"> 
      </cfif>
      <cfif #sel_hrsending_color# is "custom">
	  	<cfif trim(custom_hrsending_color) eq "">
			<cfset error_message = error_message & "<font color='Red'>Please enter custom color code for ending auction.  </font>">
		</cfif>
      <cfset sel_hrsending_color = "#custom_hrsending_color#"> 
      </cfif>
      <cfif #sel_listing_bgcolor# is "custom">
	  	<cfif trim(custom_listing_bgcolor) eq "">
			<cfset error_message = error_message & "<font color='Red'>Please enter custom color code for listing background.  </font>">
		</cfif>
        <cfset sel_listing_bgcolor = "#custom_listing_bgcolor#">
      </cfif>
	  <cfif sel_heading_color is "custom">
	  	<cfif trim(custom_heading_color) eq "">
			<cfset error_message = error_message & "<font color='Red'>Please enter custom color code for heading.  </font>">
		</cfif>
        <cfset sel_heading_color = "#custom_heading_color#"> 
      </cfif>
	  <cfif sel_heading_fcolor is "custom">
	  	<cfif trim(custom_heading_fcolor) eq "">
			<cfset error_message = error_message & "<font color='Red'>Please enter custom color code for heading font color.  </font>">
		</cfif>
     <cfset sel_heading_fcolor = "#custom_heading_fcolor#"> 
      </cfif>
	  
	  	<cfif sel_heading_font eq "">
			<cfset error_message = error_message & "<font color='Red'>Please enter font for heading.  </font>">
		</cfif>
    
    	  	<cfif sel_heading_font_size eq "">
...
UPDATE layout
SET 
<cfif isNumeric(trim(sel_heading_font_size))>
heading_fsize='#trim(sel_heading_font_size)#',
 </cfif> 
<cfif sel_heading_font neq "">
heading_font='#trim(sel_heading_font)#',
 </cfif>
<cfif trim(sel_heading_fcolor) neq ""> 
heading_fcolor='#trim(sel_heading_fcolor)#',
</cfif>

 <cfif trim(sel_heading_color) neq ""> 
 heading_color='#trim(sel_heading_color)#',
 </cfif> 

 <cfif trim(sel_listing_bgcolor) neq "">
listing_bgcolor='#trim(sel_listing_bgcolor)#',
</cfif> 

<cfif trim(sel_hrsending_color) neq ""> 
 hrsending_color='#trim(sel_hrsending_color)#',
</cfif>

<cfif trim(set_bg_color) neq ""> 
bg_color='#trim(set_bg_color)#',
</cfif>

<cfif trim(set_text_color) neq ""> 
text_color='#trim(set_text_color)#',
</cfif> 
<cfif set_text_font neq "">
text_font='#trim(set_text_font)#',
</cfif>
<cfif trim(set_vlink_color) neq ""> 
vlink_color='#trim(set_vlink_color)#',
</cfif> 

<cfif trim(set_alink_color) neq ""> 
alink_color='#trim(set_alink_color)#',
</cfif> 

 <cfif trim(set_link_color) neq "">
link_color='#trim(set_link_color)#',
</cfif> 

 <cfif trim(set_hlink_color) neq "">
hlink_color='#trim(set_hlink_color)#'
</cfif> 
</cfquery>



 <!--- Update the defaults table for pre layout table legacy pages 
      ...
      <cfquery username="#db_username#" password="#db_password#" name="update_heading_font_size" datasource="#DATASOURCE#">
          UPDATE defaults
             SET pair = '#sel_heading_font_size#'
...
<cfif isDefined("update_main_content")>
  <cfif #trim(form.main_content)# is not "">
      <cfquery username="#db_username#" password="#db_password#" name="update_main_content" datasource="#DATASOURCE#">
          update layout
set main_content='#trim(main_content)#'
  ...
  <cfmodule template="../functions/addTransaction.cfm"
      datasource="#DATASOURCE#"
      description="Update home page main_content"
      details="home page main_content updated">

<cfset error_message = "<font color='ff0000'>page main_content updated </font>">
...
<cfif isDefined("update_side_content")>
  <cfif #trim(form.side_content)# is not "">
      <cfquery username="#db_username#" password="#db_password#" name="update_side_content" datasource="#DATASOURCE#">
          update layout
set side_content='#trim(side_content)#'
  ...
  <cfmodule template="../functions/addTransaction.cfm"
      datasource="#DATASOURCE#"
      description="Update home page side_content"
      details="home page side_content updated">

<cfset error_message = "<font color='ff0000'>page side_content updated </font>">
...
<cfquery name="get_layout2" datasource="#DATASOURCE#" maxrows=1 dbtype="ODBC">
SELECT * FROM layout
WHERE id = 1
</cfquery>

<cfinclude template="../includes/stylesheet.cfm">


      <!--- Write a new body tag include file --->
      <cffile action="write" file=#expandPath ("..\includes\bodytag.html")# output="<body bgcolor='#get_layout2.bg_color#'>"><!---  text='#get_layout2.text_color#' --->
...
select button_style, button_font, button_size, button_color, button_hover,matching_bgcolor from layout
</cfquery>
...
<link rel=stylesheet href="<cfoutput>#VAROOT#</cfoutput>/includes/admin_stylesheet.css" type="text/css">
...
//		document.getElementById("buttonnumber").value = thisbutton;
		document.getElementById("buttonnum").value = thisButton;
    }
}
...
document.picture1.src = "#layout.SectionImage1#";	
document.picture2.src = "#layout.SectionImage2#";	
document.picture3.src = "#layout.SectionImage3#";	
document.picture4.src = "#layout.SectionImage4#";	
document.picture5.src = "#layout.SectionImage5#";	
document.picture6.src = "#layout.SectionImage6#";	
document.picture7.src = "#layout.SectionImage7#";	
document.picture8.src = "#layout.SectionImage8#";	
document.picture9.src = "#layout.SectionImage9#";	
//Set Column sections (see legend above)
resetDropdown1.selectedIndex = #layout.col1sec1#;	
resetDropdown2.selectedIndex = #layout.col1sec2#;	
resetDropdown3.selectedIndex = #layout.col1sec3#;	
resetDropdown4.selectedIndex = #layout.col2sec1#;	
resetDropdown5.selectedIndex = #layout.col2sec2#;	
resetDropdown6.selectedIndex = #layout.col2sec3#;	
resetDropdown7.selectedIndex = #layout.col3sec1#;	
resetDropdown8.selectedIndex = #layout.col3sec2#;	
resetDropdown9.selectedIndex = #layout.col3sec3#;	
</cfoutput>
}
...
<!--- Dark Blue #465775  Light Blue: BAC1CF --->
...
<!--- ******************************************************************** --->
      ...
      <tr>
       ...
       <table border=1 bordercolor=000000 cellspacing=0 cellpadding=0 width=900 bgcolor="#BAC1CF"><!---TABLE:OUTER BORDER--->	    
         <tr>
          <td>

           
<table border=0 cellspacing=0 cellpadding=5 width=900 bgcolor="#BAC1CF"> <!---TABLE:DESCRIPTION--->
            <tr>
             <td colspan=2>
...
<table border=0 cellspacing=0 cellpadding=3 width=900 bgcolor="#BAC1CF"><!---TABLE:MESSAGE--->
<tr>
...
<center>             
<table border=1 bordercolor=000080 cellspacing=0 cellpadding=2 width=900 bgcolor="#BAC1CF"><!---TABLE:INNER BORDER--->
...
<tr bgcolor=bac1cf>
                <td>
                 ...
                 <font face="helvetica" size=2> <cfoutput>
                  <table border=0 cellspacing=0 cellpadding=5 width=98%>
                   <tr bgcolor="##687997">
  <td align=left><font face="helvetica" size=2 color=white><b>Site Colors/Font</b></font>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
Here you can choose the colors that will be used for the entire site for various elements.
                   ...
                   <tr>
					...
					<td width=100>  
 <select name="set_link_color">
 <cfif listContains (color_codes, get_layout2.link_color) is 0>
   <cfset lc_custom_color = "1">
  <cfelse>
   <cfset lc_custom_color = "0">
  </cfif>
   <cfloop from="1" to="#listLen(color_codes)#" index="id">
    <cfset cur_code = "#listGetAt (color_codes, id)#">
    <cfset cur_name = "#listGetAt (color_names, id)#">
	<cfif lc_custom_color eq 0>
   <cfif cur_code eq get_layout2.link_color>
   <option value="#cur_code#" selected>#cur_name#</option> 
  <cfelse>
    <option value="#cur_code#">#cur_name#</option>
  </cfif>
  <cfelse>
  <cfif cur_code neq "custom">
  <option value="#cur_code#">#cur_name#</option>
  <cfelse>
  <option value="#cur_code#" selected>#cur_name#</option>
  </cfif>
  ...
  <option value="#listGetAt (color_codes, idx)#"<cfif (#get_layout2.link_color# is #cur_code#)> selected</cfif>>#cur_name#</option>
   </cfloop> --->
</select>
</td>

  <td><input name="custom_link_color" type="text" size=6 maxlength=6 <cfif lc_custom_color eq 1>value="#get_layout2.link_color#"</cfif>></td>
                    <!--- <cfmodule template="../functions/cf_colorsel.cfm" selectname="link_color" selected="#link_color#"> --->
                    <td align="right" width=70>
                     <font face="helvetica" size=2 color="#link_color#"><u>Current</u></font>
                    </td>
                   </tr>
                   ...
                   <tr>
					...
					<td width=100>  
 <select name="set_vlink_color">
  <cfif listContains (color_codes, get_layout2.vlink_color) is 0>
   <cfset vlc_custom_color = "1">
  <cfelse>
   <cfset vlc_custom_color = "0">
  </cfif>
   <cfloop from="1" to="#listLen(color_codes)#" index="ix">
    <cfset cur_code = "#listGetAt (color_codes, ix)#">
    <cfset cur_name = "#listGetAt (color_names, ix)#">
	<cfif vlc_custom_color eq 0>
   <cfif cur_code eq get_layout2.vlink_color>
   <option value="#cur_code#" selected>#cur_name#</option> 
  <cfelse>
    <option value="#cur_code#">#cur_name#</option>
  </cfif>
  ...
  <!---  <cfloop from="1" to="#listLen(color_codes)#" index="idx">
    <cfset #cur_code# = "#listGetAt (color_codes, idx)#">
    <cfset #cur_name# = "#listGetAt (color_names, idx)#">
  <option value="#listGetAt (color_codes, idx)#"<cfif (#get_layout2.vlink_color# is #cur_code#)> selected</cfif>>#cur_name#</option>
   </cfloop> --->
</select>
</td>

  <td><input name="custom_vlink_color" type="text" size=6 maxlength=6 <cfif vlc_custom_color eq 1>value="#get_layout2.vlink_color#"</cfif>></td>
                    <!--- <cfmodule template="../functions/cf_colorsel.cfm" selectname="vlink_color" selected="#vlink_color#"> --->
                    <td  align="right" width=70>
                     <font face="helvetica" size=2 color="#vlink_color#"><u>Current</u></font>
                    </td>
                   </tr>
                   ...
                   <tr>
					...
					<td width=100>  
 <select name="set_alink_color">
 <cfif listContains (color_codes, get_layout2.alink_color) is 0>
   <cfset alc_custom_color = "1">
  <cfelse>
   <cfset alc_custom_color = "0">
  </cfif>
   <cfloop from="1" to="#listLen(color_codes)#" index="dx">
    <cfset cur_code = "#listGetAt (color_codes, dx)#">
    <cfset cur_name = "#listGetAt (color_names, dx)#">
	<cfif alc_custom_color eq 0>
   <cfif cur_code eq get_layout2.alink_color>
   <option value="#cur_code#" selected>#cur_name#</option> 
  <cfelse>
    <option value="#cur_code#">#cur_name#</option>
  </cfif>
  ...
  <option value="#cur_code#" selected>#cur_name#</option>
   ...
   <!--- <cfloop from="1" to="#listLen(color_codes)#" index="idx">
    <cfset #cur_code# = "#listGetAt (color_codes, idx)#">
    <cfset #cur_name# = "#listGetAt (color_names, idx)#">
  <option value="#listGetAt (color_codes, idx)#"<cfif (#get_layout2.alink_color# is #cur_code#)> selected</cfif>>#cur_name#</option>
   </cfloop> --->
</select>
</td>

  <td><input name="custom_alink_color" type="text" size=6 maxlength=6 <cfif alc_custom_color eq 1>value="#get_layout2.alink_color#"</cfif>></td>
                    <!--- <cfmodule template="../functions/cf_colorsel.cfm" selectname="alink_color" selected="#alink_color#"> --->
                    <td align="right" width=70>
                     <font face="helvetica" size=2 color="#get_layout2.alink_color#"><u>Current</u></font>
                    </td>
                   </tr>
				    <!--- hlink color --->
                   <tr>
					...
					<td width=100>  
 <select name="set_hlink_color">
 <cfif listContains (color_codes, get_layout2.hlink_color) is 0>
   <cfset hlc_custom_color = "1">
  <cfelse>
   <cfset hlc_custom_color = "0">
  </cfif>
   <cfloop from="1" to="#listLen(color_codes)#" index="i">
    <cfset cur_code = "#listGetAt (color_codes, i)#">
    <cfset cur_name = "#listGetAt (color_names, i)#">
	<cfif hlc_custom_color eq 0>
   <cfif cur_code eq get_layout2.hlink_color>
   <option value="#cur_code#" selected>#cur_name#</option> 
  <cfelse>
    <option value="#cur_code#">#cur_name#</option>
  </cfif>
  ...
  <option value="#cur_code#" selected>#cur_name#</option>
   ...
   <!--- <cfloop from="1" to="#listLen(color_codes)#" index="idx">
    <cfset #cur_code# = "#listGetAt (color_codes, idx)#">
    <cfset #cur_name# = "#listGetAt (color_names, idx)#">
  <option value="#listGetAt (color_codes, idx)#"<cfif (#get_layout2.hlink_color# is #cur_code#)> selected</cfif>>#cur_name#</option>
   </cfloop> --->
</select>
</td>

  <td><input name="custom_hlink_color" type="text" size=6 maxlength=6 <cfif hlc_custom_color eq 1>value="#get_layout2.hlink_color#"</cfif>></td>
                    <!--- <cfmodule template="../functions/cf_colorsel.cfm" selectname="hlink_color" selected="#hlink_color#"> --->
                    <td align="right" width=70>
                     <font face="helvetica" size=2 color="#get_layout2.hlink_color#"><u>Current</u></font>
                    </td>
                   </tr>
                   ...
                   <tr>
					...
					<td width=100>  
 <select name="set_text_color">
 <cfif listContains (color_codes, get_layout2.text_color) is 0>
   <cfset tc_custom_color = "1">
  <cfelse>
   <cfset tc_custom_color = "0">
  </cfif>
   <cfloop from="1" to="#listLen(color_codes)#" index="d">
    <cfset cur_code = "#listGetAt (color_codes, d)#">
    <cfset cur_name = "#listGetAt (color_names, d)#">
	<cfif tc_custom_color eq 0>
   <cfif cur_code eq get_layout2.text_color>
   <option value="#cur_code#" selected>#cur_name#</option> 
  <cfelse>
    <option value="#cur_code#">#cur_name#</option>
  </cfif>
  ...
  <option value="#cur_code#" selected>#cur_name#</option>
   ...
   <!--- <cfloop from="1" to="#listLen(color_codes)#" index="idx">
    <cfset #cur_code# = "#listGetAt (color_codes, idx)#">
    <cfset #cur_name# = "#listGetAt (color_names, idx)#">
  <option value="#listGetAt (color_codes, idx)#"<cfif (#get_layout2.text_color# is #cur_code#)> selected</cfif>>#cur_name#</option>
   </cfloop> --->
</select>
</td>

  <td><input name="custom_text_color" type="text" size=6 maxlength=6 <cfif tc_custom_color eq 1>value="#get_layout2.text_color#"</cfif>></td>
                   <!---  <cfmodule template="../functions/cf_colorsel.cfm" selectname="text_color" selected="#text_color#"> --->
                    <td align="right" width=70>
                     <font face="helvetica" size=2 color="#get_layout2.text_color#"><u>Current</u></font>
                    </td>
                   </tr>
				    <!--- Heading font type--->
                   <tr>
					...
					<td align="left" colspan="2"><input type="Text" name="set_text_font" value="#set_text_font#" size="16"></td>
					</tr>
...
<b>Background:</b>
					...
					<td width=100>  
 <select name="set_bg_color">
 <cfif listContains (color_codes, get_layout2.bg_color) is 0>
   <cfset bgc_custom_color = "1">
  <cfelse>
   <cfset bgc_custom_color = "0">
  </cfif>
   <cfloop from="1" to="#listLen(color_codes)#" index="x">
    <cfset cur_code = "#listGetAt (color_codes, x)#">
    <cfset cur_name = "#listGetAt (color_names, x)#">
	<cfif bgc_custom_color eq 0>
   <cfif cur_code eq get_layout2.bg_color>
   <option value="#cur_code#" selected>#cur_name#</option> 
  <cfelse>
    <option value="#cur_code#">#cur_name#</option>
  </cfif>
  ...
  <option value="#cur_code#" selected>#cur_name#</option>
   ...
   <!--- <cfloop from="1" to="#listLen(color_codes)#" index="idx">
    <cfset #cur_code# = "#listGetAt (color_codes, idx)#">
    <cfset #cur_name# = "#listGetAt (color_names, idx)#">
  <option value="#listGetAt (color_codes, idx)#"<cfif (#get_layout2.bg_color# is #cur_code#)> selected</cfif>>#cur_name#</option>
   </cfloop> --->
</select>
</td>

  <td><input name="custom_bg_color" type="text" size=6 maxlength=6 <cfif bgc_custom_color eq 1>value="#get_layout2.bg_color#"</cfif>></td>
                   <!---  <cfmodule template="../functions/cf_colorsel.cfm" selectname="bg_color" selected="#bg_color#"> --->
                     ...
                     <td align="right">
                      <table border=0 bordercolor=000000 cellspacing=0 cellpadding=2>
                       <tr>
                        <td bgcolor="#get_layout2.bg_color#"><font face="helvetica" size=2>Current</font></td>
                       </tr>
                      </table> 
                   ...
                   <tr>
					...
					<td width=100>  
 <select name="sel_heading_color">
 <cfif listContains (color_codes, get_layout2.heading_color) is 0>
   <cfset heading_custom_color = "1">
  <cfelse>
   <cfset heading_custom_color = "0">
  </cfif>
   <cfloop from="1" to="#listLen(color_codes)#" index="xid">
    <cfset cur_code = "#listGetAt (color_codes, xid)#">
    <cfset cur_name = "#listGetAt (color_names, xid)#">
	<cfif heading_custom_color eq 0>
   <cfif cur_code eq get_layout2.heading_color>
   <option value="#cur_code#" selected>#cur_name#</option> 
  <cfelse>
    <option value="#cur_code#">#cur_name#</option>
  </cfif>
  ...
  <td><input name="custom_heading_color" type="text" size=6 maxlength=6 <cfif heading_custom_color eq 1>value="#get_layout2.heading_color#"</cfif>></td>
                    <!--- <cfmodule template="../functions/cf_colorsel.cfm" selectname="sel_heading_color" selected="#sel_heading_color#"> --->
                    <td align="right">
					<table border=0 bordercolor=000000 cellspacing=0 cellpadding=2>
                       <tr>
                        <td bgcolor="#get_layout2.heading_color#"><font face="helvetica" size=2 color="#get_layout2.heading_fcolor#">Current</font></td>
                       </tr>
                      </table> 
                   ...
                   <tr>
					...
					<td width=100>  
 <select name="sel_heading_fcolor">
 <cfif listContains (color_codes, get_layout2.heading_fcolor) is 0>
   <cfset heading_font_custom_color = "1">
  <cfelse>
   <cfset heading_font_custom_color = "0">
  </cfif>
   <cfloop from="1" to="#listLen(color_codes)#" index="ixd">
    <cfset cur_code = "#listGetAt (color_codes, ixd)#">
    <cfset cur_name = "#listGetAt (color_names, ixd)#">
	<cfif heading_font_custom_color eq 0>
   <cfif cur_code eq get_layout2.heading_fcolor>
   <option value="#cur_code#" selected>#cur_name#</option> 
  <cfelse>
    <option value="#cur_code#">#cur_name#</option>
  </cfif>
  ...
  <td><input name="custom_heading_fcolor" type="text" size=6 maxlength=6 <cfif heading_font_custom_color eq 1>value="#get_layout2.heading_fcolor#"</cfif>></td>
                   <!---  <cfmodule template="../functions/cf_colorsel.cfm" selectname="sel_heading_fcolor" selected="#sel_heading_fcolor#"> --->
                    <td align="right">
                    <table border=0 bordercolor=000000 cellspacing=0 cellpadding=2>
                       <tr>
                        <td bgcolor="#get_layout2.heading_color#"><font face="helvetica" size=2 color="#get_layout2.heading_fcolor#">Current</font></td>
                   ...
                   <tr>
                    <td>
                     <font face="helvetica" size=2>
                      &nbsp;<b>Heading Font Type:</b>&nbsp;
                     </font>
                    </td>
					<td align="left" colspan="2"><input type="Text" name="sel_heading_font" value="#get_layout2.heading_font#" size="16"></td>
					</tr>
                   ...
                   <tr>
					...
					<td align="left" colspan="2"><input type="Text" name="sel_heading_font_size" value="#get_layout2.heading_fsize#" size="4"></td>

                    <!--- <cfmodule template="../functions/cf_colorsel.cfm" selectname="sel_heading_fcolor" selected="#sel_heading_fcolor#"> --->
                    <td align="right" width=70>
                     <font face="#get_layout2.heading_font#" size=2>Current</font>
                    </td>
                   </tr>
...
<tr>
                   ...
                   <tr>
					...
					<td width=100>  
 <select name="sel_hrsending_color">
 <cfif listContains (color_codes, get_layout2.hrsending_color) is 0>
   <cfset hrs_custom_color = "1">
  <cfelse>
   <cfset hrs_custom_color = "0">
  </cfif>
   <cfloop from="1" to="#listLen(color_codes)#" index="xid">
    <cfset cur_code = "#listGetAt (color_codes, xid)#">
    <cfset cur_name = "#listGetAt (color_names, xid)#">
	<cfif hrs_custom_color eq 0>
   <cfif cur_code eq get_layout2.hrsending_color>
   <option value="#cur_code#" selected>#cur_name#</option> 
  <cfelse>
    <option value="#cur_code#">#cur_name#</option>
  </cfif>
  ...
  <td><input name="custom_hrsending_color" type="text" size=6 maxlength=6 <cfif hrs_custom_color eq 1>value="#get_layout2.hrsending_color#"</cfif>></td>
                   <!---  <cfmodule template="../functions/cf_colorsel.cfm" selectname="hrsending_color" selected="#hrsending_color#"> --->
                    <td align="right" width=70>
                     <font face="helvetica" size=2 color="#hrsending_color#">Current</font>
                    </td>
                   </tr>
                   ...
                   <tr>
					...
					<td width=100>  
 <select name="sel_listing_bgcolor">
 <cfif listContains (color_codes, get_layout2.listing_bgcolor) is 0>
   <cfset lbg_custom_color = "1">
  <cfelse>
   <cfset lbg_custom_color = "0">
  </cfif>
   <cfloop from="1" to="#listLen(color_codes)#" index="xi">
    <cfset cur_code = "#listGetAt (color_codes, xi)#">
    <cfset cur_name = "#listGetAt (color_names, xi)#">
	<cfif lbg_custom_color eq 0>
   <cfif cur_code eq get_layout2.listing_bgcolor>
   <option value="#cur_code#" selected>#cur_name#</option> 
  <cfelse>
    <option value="#cur_code#">#cur_name#</option>
  </cfif>
  ...
  <option value="#cur_code#" selected>#cur_name#</option>
   ...
   <!--- <cfloop from="1" to="#listLen(color_codes)#" index="idx">
    <cfset #cur_code# = "#listGetAt (color_codes, idx)#">
    <cfset #cur_name# = "#listGetAt (color_names, idx)#">
  <option value="#listGetAt (color_codes, idx)#"<cfif (#get_layout2.listing_bgcolor# is #cur_code#)> selected</cfif>>#cur_name#</option>
   </cfloop> --->
</select>
</td>

  <td><input name="custom_listing_bgcolor" type="text" size=6 maxlength=6 <cfif lbg_custom_color eq 1>value="#get_layout2.listing_bgcolor#"</cfif>></td>
...
<a class="quicknote" href="#"><img src="images/clipnote.gif" border=0 align=middle><span>
<img src="images/QuickNote.gif"><br>
Set your desired page layout by adjusting the columns below.  
</span></a>
...
<li>Images should be limited to no more than <b>320 pixels</b> in width.
<li>YOU MUST CLICK "APPLY" (BELOW) TO SAVE YOUR CHANGES.
<ul>
</div><br>
</fieldset>
</td>
...
<OPTION VALUE="imageonly">IMAGE: <cfoutput>#Replace(layout.pageimage1,"layoutimages/","")#</cfoutput></option>
</SELECT><br><br>
Section 2
...
<OPTION VALUE="promotions">Promotions</option>
<OPTION VALUE="newusers">Welcome New Users</option>
<OPTION VALUE="imageonly">IMAGE: <cfoutput>#Replace(layout.pageimage2,"layoutimages/","")#</cfoutput></option>
</SELECT><br><br>
Section 3
...
<OPTION VALUE="promotions">Promotions</option>
<OPTION VALUE="newusers">Welcome New Users</option>
<OPTION VALUE="imageonly">IMAGE: <cfoutput>#Replace(layout.pageimage3,"layoutimages/","")#</cfoutput></option>
</SELECT>
</fieldset>
</td>
<! --- ******************************************************** --->
...
<OPTION VALUE="promotions">Promotions</option>
<OPTION VALUE="newusers">Welcome New Users</option>
<OPTION VALUE="imageonly">IMAGE: <cfoutput>#Replace(layout.pageimage4,"layoutimages/","")#</cfoutput></option>
</SELECT><br><br>
Section 2
...
<OPTION VALUE="promotions">Promotions</option>
<OPTION VALUE="newusers">Welcome New Users</option>
<OPTION VALUE="imageonly">IMAGE: <cfoutput>#Replace(layout.pageimage5,"layoutimages/","")#</cfoutput></option>
</SELECT><br><br>
Section 3
...
<OPTION VALUE="promotions">Promotions</option>
<OPTION VALUE="newusers">Welcome New Users</option>
<OPTION VALUE="imageonly">IMAGE: <cfoutput>#Replace(layout.pageimage6,"layoutimages/","")#</cfoutput></option>
</SELECT>
</fieldset>
</td>
<! --- ******************************************************** --->
...
<OPTION VALUE="promotions">Promotions</option>
<OPTION VALUE="newusers">Welcome New Users</option>
<OPTION VALUE="imageonly">IMAGE: <cfoutput>#Replace(layout.pageimage7,"layoutimages/","")#</cfoutput></option>
</SELECT><br><br>
Section 2
...
<OPTION VALUE="newusers">Welcome New Users</option>
<OPTION VALUE="imageonly">IMAGE: <cfoutput>#Replace(layout.pageimage8,"layoutimages/","")#</cfoutput></option>
</SELECT><br><br>
Section 3
...
<OPTION VALUE="imageonly">IMAGE: <cfoutput>#Replace(layout.pageimage9,"layoutimages/","")#</cfoutput></option>
</SELECT>
</fieldset>
</div>
</td>
...
<br><br><input type="submit" name="ChangeHeadingStyle" value="Change Heading Style" width=64><br>
<br>
</td></tr>
 FOR FUTURE UPGRADE --->
...
&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id="buttonnum" name="buttonnumber" size=2 value="<cfoutput>#layoutbutton.button_style#</cfoutput>" style="background:transparent; border:0px; text-align:center;">
<input type="button" onclick="nextButton()" Value=" > ">
<br><br>
<font size=1 face="arial">(Select one of 34 buttons above)</font>
</fieldset>
...
<select id="ffamily" name="ffamily" onChange="ShowText()"><option value="arial"<cfif layoutbutton.button_font eq "arial"> selected</cfif>>Arial</option><option value="times"<cfif layoutbutton.button_font eq "times"> selected</cfif>>Times Roman</option><option value="cursive"<cfif layoutbutton.button_font eq "cursive"> selected</cfif>>Cursive</option><option value="verdana"<cfif layoutbutton.button_font eq "verdana"> selected</cfif>>Verdana</option></select>
<select id="fsize" name="fsize" onChange="ShowText()"><option value="11"<cfif layoutbutton.button_size eq "11"> selected</cfif>>11</option><option value="12"<cfif layoutbutton.button_size eq "12"> selected</cfif>>12</option><option value="13"<cfif layoutbutton.button_size eq "13"> selected</cfif>>13</option></select>
...
<input type=checkbox name="matching_bgcolor" value="1" <cfif layoutbutton.matching_bgcolor eq 1>checked</cfif>> Dispay matching background color around button. <!---<cfoutput>#layoutbutton.matching_bgcolor#</cfoutput>--->
<br><br>(Move mouse over button sample to test.<br>
...
<!--- <br><input type="submit" name="submit" value="Change Button" width=64><font face="helvetica" size=1><b> (Refresh browser to view changes)</font> ---><br>
...
<div class="header" id="maincontent-header">Home Page Content</div>
 ...
 <tr>
                   ...
                   <tr>
                    <td valign="top">
                     <font face="helvetica" size=2>
                      &nbsp;<b>Main Content:</b>&nbsp;
                     </font><font size=1>(Enter your  home page (main content)   here)</font>
                    </td>

 <td colspan=3>

             <textarea name="main_content" cols=70 rows=6>
<cfif #get_aboutus.recordcount#>
<cfoutput>#trim(get_aboutus.main_content)#</cfoutput></cfif> </textarea>

&nbsp;<br><input type="submit" name="update_main_content" value="Update Home Page (main content)" width=64>
                    </td>
                   ...
                   <tr>
                    <td valign="top">
                     <font face="helvetica" size=2>
                      &nbsp;<b>Side Content:</b>&nbsp;
                     </font><font size=1>(Enter your  home page (side content)   here)</font>
                    </td>

 <td colspan=3>


             <textarea name="side_content" cols=70 rows=6>
<cfif #get_aboutus.recordcount#>
<cfoutput>#trim(get_aboutus.side_content)#</cfoutput></cfif> </textarea>

&nbsp;<br><input type="submit" name="update_side_content" value="Update Home Page (side content)" width=64>
                    </td>
...
<td>
<div style="display:none">
<input type="title" name="title" value="" size=68 maxlength=255>
</div>
</td>
<td>&nbsp;</td>
</tr>
...
select * from news
					 ...
					 <tr>
                    <td valign="bottom"><font face="helvetica" size=2>
<div style="display:none">

<b>Delete News:</b></font>
</div>
</td>
                   	 <td colspan="3">
<div style="display:none">
News<br><select name="selected_news" size=1 width=20><option value="-1"><cfloop query="get_news"><cfoutput><option value="#title#">#left((get_news.title),60)#</cfoutput></option></cfloop></select>
					 <cfif #get_news.recordcount# GT 0>&nbsp;<input type="submit" name="del_news" value="Delete" width=64><cfelse>&nbsp;</cfif>

</div>
					 </td>
                     </tr>
<!--- End Hide news Section Div --->
