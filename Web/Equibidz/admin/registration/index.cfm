...
<cfif #submit# is "Next >>">
  ...
  <cfset #fax# = #trim (fax)#>
  <cfset #promotion_code# = #trim (promotion_code)#>
  ...
  <cfif #error_list# is ""
   ...
   VALUES     (#user_id#,
               ...
               #createODBCDateTime(timenow)#,
               0.00,
			   <cfif cc_name neq "">'#cc_name#'<cfelse>'0'</cfif>,
   ...
   <!--- membership --->
   <cfif get_membership_status.pair eq 1 and membership neq "">
...
<cfmodule template="../event2/expire/auth_net_automated_billing.cfm"
		...
		<!--- send email --->
		<cfmodule template="eml_membership.cfm"
			itemnum="0"
			title="New Membership (#nickname#)"
...
--->
      ...
      <table border=0 cellspacing=0 cellpadding=2 width=640>
        <!--- <tr>
          <td><center><IMG SRC="#VAROOT#/images/logohere.gif"> &nbsp; &nbsp; &nbsp;   <font size=2><cfinclude template="../includes/menu_bar.cfm"></font></center><br></td>
        </tr> --->
      ...
      <P align=center>
		...
		<tr>
          <td><font size=2><cfinclude template="../includes/copyrights.cfm"></font></td>
        </tr>
		</table>
		<cfabort>
		<cfelse>
        ...
        <tr>
          <td>
            <!---       #error_list# --->
              ...
              Required items are in <font color="0000ff"><b>blue</b></font>; all others are optional.<br>
              <br>
            ...
            <table border=1 cellspacing=0 cellpadding=4 bordercolor="000000">
              <tr>
                <td bgcolor="#header_bg#"><font <cfif #listFind (error_list, "nickname")#>color="ff0000"<cfelse>color="0000ff"</cfif>><b>Choose a Nickname:</b></font></td>
                <td>
              ...
              <tr>
                <td width=210 bgcolor="#header_bg#"><font <cfif #listFind (error_list, "password")#>color="ff0000"<cfelse>color="0000ff"</cfif>><b>Choose a Password:</b></font></td>
              ...
              <tr>
                <td width=210 bgcolor="#header_bg#"><font <cfif #listFind (error_list, "password2")#>color="ff0000"<cfelse>color="0000ff"</cfif>><b>Confirm Password:</b></font></td>
			  ...
			  <tr>
                <td width=210 bgcolor="#header_bg#"><font <cfif #listFind (error_list, "keyword")#>color="ff0000"<cfelse>color="0000ff"</cfif>><b>Choose a keyword:</b></font></td>
              ...
              <tr>
                <td width=210 bgcolor="#header_bg#"><font <cfif #listFind (error_list, "email")#>color="ff0000"<cfelse>color="0000ff"</cfif>><b>E-mail address:</b></font></td>
              ...
              <tr>
                <td bgcolor="#header_bg#"><font <cfif #listFind (error_list, "email_confirm")#>color="ff0000"<cfelse>color="0000ff"</cfif>><b>Confirm E-mail address:</b></font></td>
			  ...
			  <tr>
                <td bgcolor="#header_bg#" valign="top"><b>Email me when</b></td>
              ...
              <tr>
                <td bgcolor="#header_bg#"><font <cfif #listFind (error_list, "name")#>color="ff0000"<cfelse>color="0000ff"</cfif>><b>Full name:</b></font></td>
              ...
              <tr>
                <td bgcolor="#header_bg#"><b>Company:</b></td>
			  ...
			  <tr>
                <td bgcolor="#header_bg#"><font color="0000ff"><b>What language do you prefer?</b></font></td>
              ...
              <tr>
                <td bgcolor="#header_bg#"><font <cfif #listFind (error_list, "phone1")#>color="ff0000"<cfelse>color="0000ff"</cfif>><b>Primary phone ##:</b></font></td>
              ...
              <tr>
                <td bgcolor="#header_bg#"><b>Secondary phone ##:</b></td>
              ...
              <tr>
                <td bgcolor="#header_bg#"><b>Fax ##:</b></td>
                <td><table border=0 cellspacing=0 cellpadding=0 width=100%><tr><td><input name="fax" size=20 maxlength=20 value="#fax#"></td><td align="right">&nbsp;&nbsp;<font size=2>(e.g., (714) 555-1213)</font></td></tr></table></td>
                      ...
                      <tr>
                        <td bgcolor="#header_bg#"><font <cfif #cc_number_error# is not "">color="ff0000"<cfelse>color="000000"</cfif>><b>Credit card number:</b></font></td>
                        <td>
                          <table border=0 cellspacing=0 cellpadding=0 width=100%>
                            <tr>
                      ...
                      <tr>
                        <td bgcolor="#header_bg#"><font <cfif #cc_name_error# is not "">color="ff0000"<cfelse>color="000000"</cfif>><b>Name of cardholder:<font size="2"> </font></b></font></td>
                        <td>
                          <table border=0 cellspacing=0 cellpadding=0 width=100%>
                            <tr>
                      ...
                      <tr>
                        <td bgcolor="#header_bg#"><font <cfif #cc_expiration_error# is not "">color="ff0000"<cfelse>color="000000"</cfif>><b>Expiration date: </b></font></td>
                        <td>
                          <table border=0 cellspacing=0 cellpadding=0 width=100%>
                            <tr>
              ...
              <tr>
                <td bgcolor="#header_bg#"><font <cfif #listFind (error_list, "address1")#>color="ff0000"<cfelse>color="0000ff"</cfif>><b>Address:</b></font></td>
              ...
              <tr>
                <td bgcolor="#header_bg#"><font color="000000"><b>Address (Line 2):</b></font></td>
              ...
              <tr>
                <td bgcolor="#header_bg#"><font <cfif #listFind (error_list, "city")#>color="ff0000"<cfelse>color="0000ff"</cfif>><b>City:</b></font></td>
              ...
              <tr>
                <td bgcolor="#header_bg#"><font <cfif #listFind (error_list, "state")#>color="ff0000"<cfelse>color="0000ff"</cfif>><b>State/Province:</b></font></td>
                <td><table border=0 cellspacing=0 cellpadding=0 width=100%><tr><td><input name="state" size=15 maxlength=50 value="#state#"></td><td align="right">&nbsp;&nbsp;<font size=2>(e.g., Illinois)</font></td></tr></table></td>
              </tr>
              <tr>
                <td bgcolor="#header_bg#"><font <cfif #listFind (error_list, "postal_code")#>color="ff0000"<cfelse>color="0000ff"</cfif>><b>Zip Code:</b></font></td>
              ...
              <tr>
                <td bgcolor="#header_bg#"><font color="0000ff"><b>Country:</b></font></td>
			  ...
			  <tr>
                <td bgcolor="#header_bg#" valign="top"><font color="000000"><b>Shipping Information:</b></font></td>
                <td><table border=0 cellspacing=0 cellpadding=0 width=100%><tr><td>
			  ...
			  <tr>
                <td bgcolor="#header_bg#"><font <cfif #listFind (error_list, "shipping_address1")#>color="ff0000"<cfelse>color="0000ff"</cfif>><b>Shipping Address:</b></font></td>
              ...
              <tr>
                <td bgcolor="#header_bg#"><font color="000000"><b>Shipping Address (Line 2):</b></font></td>
              ...
              <tr>
                <td bgcolor="#header_bg#"><font <cfif #listFind (error_list, "shipping_city")#>color="ff0000"<cfelse>color="0000ff"</cfif>><b>Shipping City:</b></font></td>
              ...
              <tr>
                <td bgcolor="#header_bg#"><font <cfif #listFind (error_list, "shipping_state")#>color="ff0000"<cfelse>color="0000ff"</cfif>><b>Shipping State/Province:</b></font></td>
                <td><table border=0 cellspacing=0 cellpadding=0 width=100%><tr><td><input name="shipping_state" size=15 maxlength=50 value="#shipping_state#"></td><td align="right">&nbsp;&nbsp;<font size=2>(e.g., Illinois)</font></td></tr></table></td>
              </tr>
              <tr>
                <td bgcolor="#header_bg#"><font <cfif #listFind (error_list, "shipping_postal_code")#>color="ff0000"<cfelse>color="0000ff"</cfif>><b>Shipping Zip Code:</b></font></td>
              ...
              <tr>
                <td bgcolor="#header_bg#"><font color="0000ff"><b>Shipping Country:</b></font></td>
            ...
            <table border=1 cellspacing=0 cellpadding=4 bordercolor="000000">
              <tr>
                <td width=210 bgcolor="#header_bg#">
                  <font color="000000">
                    <b>Optional Info</b>
                  </font>
                </td>
			  ...
			  <cfif get_membership_status.pair eq 1>
			  <tr>
                <td bgcolor="#header_bg#" valign="bottom"><font color="000000"><b>Membership </b></font><br><a href="../help/about_membership.cfm" target="_blank"><font size="-2">about membership</font></a></td>
                <td>
              ...
              <tr>
                <td bgcolor="#header_bg#"><font color="000000"><b>How did you hear about us?</b></font></td>
                <td>
              ...
              <tr>
                <td bgcolor="#header_bg#"><font color="000000"><b>Promotion code:</b></font></td>
                <td><input name="promotion_code" type="text" size=10 maxlength=10 value="#promotion_code#"></td>
              </tr>
              <tr>
                <td bgcolor="#header_bg#"><font <cfif #listFind (error_list, "friendsemail")#> color="ff0000"<cfelse>color="000000"</cfif>><b>If a friend referred you<br>to us, enter their email address:</b></font></td>
                <td><input name="friends_email" type="text" size=30 maxlength=65 value="#friends_email#"></td>
              </tr>
              <tr>
                <td bgcolor="#header_bg#"><font color="000000"><b>What do you use our site for?</b></font></td>
                <td>
                  <select name="use_for">
              ...
              <tr>
                <td bgcolor="#header_bg#"><font color="000000"><b>I am most interested in:</b></font></td>
                <td><input name="interested" type="text" size=30 maxlength=50 value="#interested#"></td>
              </tr>
              <tr>
                <td bgcolor="#header_bg#"><font color="000000"><b>Age:</b></font></td>
                <td>
                  <select name="age">
              ...
              <tr>
                <td bgcolor="#header_bg#"><font color="000000"><b>Education completed:</b></font></td>
                <td>
              ...
              <tr>
                <td bgcolor="#header_bg#"><font color="000000"><b>Annual household income:</b></font></td>
                <td>
                  <select name="income">
              ...
              <tr>
                <td bgcolor="#header_bg#"><font color="000000"><b>Do you wish to participate in our online survey?</b></font></td>
                <td>
                  <select name="survey">
              ...
              <tr>
                <td bgcolor="#header_bg#"><font color="000000"><b>Would you like to be on our mailing list?</b></font></td>
                <td>
                  <select name="mailing">
              ...
              <tr>
                <td bgcolor="#header_bg#"><font color="000000"><b>Gender:</b></font></td>
                <td>
                  <select name="gender">
        ...
        <tr>
          <td><br><br>         <hr size=1 color=#heading_color# width=100%></td>
        </tr>
        <tr>
          <td><font size=2><cfinclude template="../includes/copyrights.cfm"></font></td>
        </tr>
