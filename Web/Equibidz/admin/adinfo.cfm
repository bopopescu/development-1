...
<tr>
<tr>
<td align="right"><input type="submit" name="submit"></td><td> <button onclick="window.close()"> Close </button></td>
</tr>
</form>
</table>
<hr>
...
<!------- GET FORM DATA ----------->
	...
	<cfelse>
		...
		<font size="2px"> Record Updated </font>
