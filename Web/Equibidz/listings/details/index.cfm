	  ...
	  <tr><td>
	      ...
	      <tr><td align="center"><br>
	          <!--- JM color="CDC8AB"---><font size=3><b>&nbsp;Category:&nbsp;&nbsp;&nbsp;#get_CatName.name#</b></font><br>
 		      <!--- JM color="CDC8AB"---><font size=4><b>#get_Item.name#&nbsp;(Entry: #get_Item.itemnum#)&nbsp;&nbsp;#get_Item.list_type#</b></font><br><br>
  		              ...
  		              <table width='100%' cellpadding="0" cellspacing="0">
  		                 <tr><td align="center">
  		                    <table width='500' cellpadding="0" cellspacing="0">
  		                       <tr><td align="center" valign="center"><img src="#VAROOT#/fullsize_thumbs/#get_Item.picture1#" border=1 width="#resizedImageWidth#"></td></tr>
  		                    </table>    
  		                 </td></tr>
  		                 <tr><td>&nbsp;</td></tr>
                          ...
                          <table width='100%' border="0" cellpadding="3" cellspacing="5">
                             ...
                             <tr>
  		                     ...
  		                     <tr>
  		                        ...
  		                        <td width="65%"><cfif get_Item.province neq "">#get_Item.province#,&nbsp;</cfif>#get_Item.country#</td>
  		                     </tr>  		                     
  		           ...
  		           <td width="351" valign="top">
                      <table width='351' border="1" cellpadding="0" cellspacing="0">
  		                 <tr><td align="center"><b><br>
							...
							<cfelseif #get_HighBid.bid# GT #get_Item.buynow_price#>
                               <font size=5 color="5688b9"><b>PRICE IS ABOVE BUY NOW</b></font><br>
                               <font size=5 color="5688b9">at #dollarformat(get_HighBid.bid)#&nbsp;USD</font>
							   
							      
		                    <cfelseif #get_Item.status# EQ 1 AND #get_Item.date_end# GT #TIMENOW#>
							   <img src="#VAROOT#/images/Clock.gif" height=18 width=18><font color="5688b9"><!---<img src="<!---#VAROOT#--->../images/clock.gif"---> <!---height=18 width=18>--->&nbsp;&nbsp;Time Remaining:</font><br>		                    
                      ...
                      <table width='100%' border="1" cellpadding="0" cellspacing="0">
                        ...
                        <table width='100%' border="0" cellpadding="5" cellspacing="5">
                           <cfif #get_Item.buynow_price# GT 0>
	                          ...
	                          <cfif #get_HighBid.winner# NEQ 1 AND #get_HighBid.buynow# NEQ 1 AND #from_list# LTE 1 AND #get_HighBid.bid# LT #get_Item.buynow_price#>
                     ...
                     <table width='100%' border="1" cellpadding="0" cellspacing="0">
                        ...
                        <tr><td align="center">
                            <table width='98%' border="0" cellpadding="5" cellspacing="5">
                               ...
                               <tr align="center">
                                 <td><cfif #get_Item.picture1# is not ""><img src="#VAROOT#/fullsize_thumbs/#get_Item.picture1#" border=1 width="#resizedImageWidth#"><cfelse>&nbsp;</cfif></td>
                                 <td><cfif #get_Item.picture2# is not ""><img src="#VAROOT#/fullsize_thumbs1/#get_Item.picture2#" border=1 width="#resizedImageWidth#"><cfelse>&nbsp;</cfif></td>
                                 <td><cfif #get_Item.picture3# is not ""><img src="#VAROOT#/fullsize_thumbs2/#get_Item.picture3#" border=1 width="#resizedImageWidth#"><cfelse>&nbsp;</cfif></td>
                               </tr>  
                               <tr align="center">
                                 <td><cfif #get_Item.picture4# is not ""><img src="#VAROOT#/fullsize_thumbs3/#get_Item.picture4#" border=1 width="#resizedImageWidth#"><cfelse>&nbsp;</cfif></td>
                                 <td><cfif #get_Item.picture5# is not ""><img src="#VAROOT#/fullsize_thumbs4/#get_Item.picture5#" border=1 width="#resizedImageWidth#"><cfelse>&nbsp;</cfif></td>
                                 <td><cfif #get_Item.picture6# is not ""><img src="#VAROOT#/fullsize_thumbs5/#get_Item.picture6#" border=1 width="#resizedImageWidth#"><cfelse>&nbsp;</cfif></td>
                               </tr>  
  		                    </table>
                        </td></tr>
  		             </table>      
                        ...
                        <table width='100%' border="0" cellpadding="0" cellspacing="5">
                           <tr><td>
							   <ul>
								  ...
								  <li>Payments must be made to Seller as agreed in the listing of the sale.</li>
								  <li>Complete payment information will be sent to the winning bidder by email when the settlement closes.</li>
								  <!--- Jm 05/01/2013<li>Unsold listings are now available for immediate purchase through this website.</li>--->
							   </ul>
                           </td></tr>
  		                </table>   
  		                </td></tr>
