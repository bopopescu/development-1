 ...
 --->
      ...
      <cfif isvalid>
        <table border=0 cellspacing=0 cellpadding=0 noshade width=800>
          <tr>
            <td>
              ...
              <br>
              If you have any questions about this item, please contact the seller using 
              the link provided below.  Seller assumes all responsibility for listing 
              this item.<br>
              <br>
            </td>
          </tr>
        ...
        <table border=0 cellspacing=0 cellpadding=1 noshade width=800>
          <!--- <tr>
            <td width=320><b>Last buynow for this item:</b></td>
          ...
          <!--- <tr>
            <td>First bid at<b>:</b></td>
            <td>#numberFormat(get_ItemInfo.minimum_bid,numbermask)# #Trim(getCurrency.type)#</td>
          </tr> --->
          <tr>
            <td><b>Number of buynows made:</b></td>
            <td><b>#numberBids#</b> <cfif numberBids GT 1><font size=2>(may include multiple bids by the same bidder)</font></cfif></td>
          </tr>
          <tr>
            <td colspan=2>[<a href="./index.cfm?itemnum=#get_ItemInfo.itemnum#">Item Details</a>] [<a href="./index.cfm?itemnum=#get_ItemInfo.itemnum###BID">BuyNow on Item</a>]</td>
          </tr>
        </table>
        </cfoutput>
        <br>
        <table border=0 cellspacing=0 cellpadding=1 noshade width=800>
          <tr>
            <td>
              <font size=4><b>BuyNow Placed</b></font>
                          <hr size=2 color=#heading_color# width=100%>
              <center>
