...
<cfif #session.auction_mode# is 0>
	...
	<cfif isvalid>
		  ...
		  <cfquery name="getpremium" datasource="#DATASOURCE#">
			  SELECT pair AS premium
				FROM defaults
			   WHERE name = 'premium'
		  </cfquery>
  
		  <cfquery name="getadministrative" datasource="#DATASOURCE#">
			  SELECT pair AS administrative
				FROM defaults
			   WHERE name = 'administrative'
		  </cfquery>
		  
		  <cfquery name="getfinancial" datasource="#DATASOURCE#">
			  SELECT pair AS financial
				FROM defaults
  ...
  <!--- define time left --->
		  ...
		  <cftry> 
			<cfquery name="getHighBidder" datasource="#DATASOURCE#" maxrows="1">
				...
				SELECT user_id,buynow
				 ...
				 --->
				 	SELECT b.user_id, buynow, bid, nickname, email, membership_status
					FROM bids b
			...
			<cfif getHighBidder.RecordCount  >
			  <cfset bidderNickname = Trim(getHighBidder.nickname)>
			  <cfset bidderEmail = Trim(getHighBidder.email)>
			  <cfset bidderId = getHighBidder.user_id>
			  <cfset bidderAmount = getHighBidder.bid>
	  ...
	  <cftry>
		...
		<!---<cfif fileExists("#thePath##itemnum#.jpg")>
				  ...
				  <td width="100%">
					<table width="100%" bgcolor=#heading_color#><tr><td width="800" align="center" valign="middle">
...
<i>              Server time :#DateFormat(TIMENOW, "mmm-d-yyyy")#, #TimeFormat(TIMENOW, "HH:mm:sstt")#;&nbsp #TIME_ZONE#
		...
		<cfif #getpremium.premium# is not "0">
		<tr>
		<td align=center>

		<font color=red size=1><b><i>There will be #getpremium.premium# % buyer premium for all auction winners.</i></b></font>
		...
		<cfif #getadministrative.administrative# is not "0">
		<tr>
		<td align=center>

		<font color=red size=1><b><i>There will be #numberformat(LSParseCurrency(getadministrative.administrative),numbermask)# #getCurrency.type# administrative fee for all auction winners.</i></b></font>
		...
		<cfif #getfinancial.financial# is not "0">
		<tr>
		<td align=center>

		<font color=red size=1><b><i>There will be #numberformat(LSParseCurrency(getfinancial.financial),numbermask)# #getCurrency.type# financial fee for all auction winners.</i></b></font>
		...
		<cfif  #get_ItemInfo.shipping_fee# is not "0">
		<tr>
		<td align=center>

<!--- 		<font color=red size=1><b><i>There will be #numberformat(LSParseCurrency(get_ItemInfo.shipping_fee),numbermask)# #getCurrency.type# shipping fee for all auction winners.</i></b></font>--->
		...
		<tr>
			<td align=center>
				...
				<font color=red size=1><b><i>State taxes may apply.</i></b></font>
...
--->
        <tr>
          ...
          <td colspan=3 valign=top>
            <font size=2>
            <cfif bidderNickname IS NOT "Not Available" ><b>
				<a href="#questionLinkBid#">#bidderNickname#</a> 
				(<a href="#VAROOT#/feedback/index.cfm?user_id=#bidderId#">#ratingBidder#</a>
			
				<b>
					<a href="#VAROOT#/feedback/legend.cfm">
						<cfif ratingbidder LTE 9>
							<img align="ABSMIDDLE" border="0" src="/legends/#get_layout.legend1#">
						<cfelseif ratingbidder LTE 49>
							<img align="ABSMIDDLE" border="0" src="/legends/#get_layout.legend2#">
						<cfelseif ratingbidder LTE 99>
							<img align="ABSMIDDLE" border="0" src="/legends/#get_layout.legend3#">
						<cfelseif ratingbidder LTE 499>
							<img align="ABSMIDDLE" border="0" src="/legends/#get_layout.legend4#">
						<cfelseif ratingbidder LTE 999>
							<img align="ABSMIDDLE" border="0" src="/legends/#get_layout.legend5#">
						<cfelseif ratingbidder LTE 4999>
							<img align="ABSMIDDLE" border="0" src="/legends/#get_layout.legend6#">
						<cfelseif ratingbidder LTE 9999>
							<img align="ABSMIDDLE" border="0" src="/legends/#get_layout.legend7#">
						<cfelseif ratingbidder LTE 24999>
							<img align="ABSMIDDLE" border="0" src="/legends/#get_layout.legend8#">
						<cfelseif ratingbidder LTE 49999>
							<img align="ABSMIDDLE" border="0" src="/legends/#get_layout.legend9#">
						<cfelseif ratingbidder LTE 99999>
							<img align="ABSMIDDLE" border="0" src="/legends/#get_layout.legend10#">
						<cfelse>
							<img align="ABSMIDDLE" border="0" src="/legends/#get_layout.legend11#">
						</cfif>
						...
						<cfif getbidderInfo.mypage neq "">
							<a href="../../personal/mypage.cfm?nickname=#get_SellerInfo.nickname#" target="_blank">
							<img src="/legends/#get_layout.aboutmeicon#"  border="0" align="absbotton">
							</a>
						</cfif>
       
			<cfif #getbidderInfo.membership_status# eq 1>
				<a href="../../help/about_membership.cfm" target="_blank">
					<img src="/legends/#get_layout.membershipicon#"  border="0" align="absbotton"></a>
			</cfif> 
...
<tr>
	...
	<table border="3"><tr><td>
	   ...
	   <input type=hidden value="Review Bid" name="reviewBid">
       <table border=0 cellspacing=0 cellpadding=0 noshade width=800>
          <tr>
        ...
        <b>Password</b> (<a href="#VAROOT#/registration/findpassword.cfm">forgotten it?</a>)<br>
			...
			<tr><td <cfif #get_iteminfo.buynow# eq 1 and numberformat(REReplace(minimumBid, "[^0123456789.]", "", "ALL"),'#numbermask#') lte numberformat(get_ItemInfo.buynow_price,'#numbermask#')>width="320"</cfif>><table>
          <cfif get_ItemInfo.auction_type IS "E" OR get_ItemInfo.auction_type IS "V">
            <tr>
			<td><table><tr>
          ...
          <!--- <table border=0 cellspacing=0 cellpadding=0 noshade width=800> --->
            ...
            <tr>
              <td colspan=2>
                ...
                <br><cfif get_ItemInfo.date_start lt timenow and get_ItemInfo.date_end gt timenow><input type=submit value="Review Bid" name="reviewBid"><cfelse><b>Unavailable for Bidding at this time</b></cfif>
			  ...
			  <td valign="top" align="center">
			  	<table>
					<tr>
						...
						&nbsp;
					<cfif get_ItemInfo.date_start lt timenow and get_ItemInfo.date_end gt timenow><input type=submit value="Buy Now" name="buynow_yes"><cfelse><b>Unavailable for purchase at this time</b></cfif>
						</td>
					</tr>
			  	</table>
			  </td>
...
<!-- 
#######################################################
NEED TO CHECK THIS WITH THE QUERY RESULT
########################################################
          ...
          <table border=0 cellspacing=0 cellpadding=0 noshade width=800>
            ...
            <tr>
              <td colspan=2>
                ...
                <br>
				<cfif get_ItemInfo.date_start lt timenow and get_ItemInfo.date_end gt timenow>
                <input type=submit value="Review Offer" name="reviewBid"><cfelse><b>Unavailable for Bidding at this time</b>
				</cfif>
				<br>
                <input type=hidden name="itemnum" value="#get_ItemInfo.itemnum#">
                <br>
