...
<cftry>
  <cfquery username="#db_username#" password="#db_password#" name="get_Item" datasource="#DATASOURCE#">
    SELECT *, (SELECT nickname FROM users WHERE items.user_id = users.user_id) AS nickname,status,
...
<cfset terms = Replace(#get_terms.terms#,  chr(13) & chr(10), "<br>", "ALL")>
...
<body>
<table border='0' width=1000 style="background-image: url('#VAROOT#/images/bg_table.jpg')" cellpadding="0" cellspacing="0">
<tr><td><br></td></tr>
<tr valign="top">
	<td align="center">
	...
	<table border='1' width=980 cellpadding="0" cellspacing="0">
	  <tr><td>
	      ...
	      <tr><td align="center"><br>
	          <font size=3 color="CDC8AB"><b>&nbsp;Category:&nbsp;&nbsp;&nbsp;#get_CatName.name#</b></font><br>
 		      <font size=4 color="CDC8AB"><b>#get_Item.name#&nbsp;(Entry: #get_Item.itemnum#)&nbsp;&nbsp;#get_Item.list_type#</b></font><br><br>
	          <table width='850' cellpadding="0" cellspacing="0">
  		         ...
  		         <tr>
  		           <td width="540" align="center" valign="top">
  		              <table width='100%' cellpadding="0" cellspacing="0">
  		                 ...
  		                 <tr><td>&nbsp;</td></tr>
  		                 <tr><td align="center"><b>#trim(get_Item.name)#&nbsp;#trim(get_Item.pri_breed)#&nbsp;#trim(get_Item.year_foaled)#&nbsp;#trim(get_Item.color)#</b></td></tr>
  		                 <tr><td>&nbsp;</td></tr>   
  		                 <tr><td>
                        ...
                        <tr><td>
                          <table width='100%' border="0" cellpadding="3" cellspacing="5">
                             ...
                             <tr>
                                ...
                                <td width="65%">#get_Item.city#&nbsp;#get_Item.state#&nbsp;USA</td>
  		                     </tr>  		                     
  		                     <tr>
  		                        <td width="35%"><b>&nbsp;&nbsp;Breed:</b></td>
  		                     ...
  		                     <tr>
  		                        ...
  		                        <td width="65%"><cfif #get_Item.shipped_semen# is "A">Available<cfelse>Not Available</cfif></td>
  		                      </tr>
  		                     <tr>
  		                        <td width="35%"><b>&nbsp;&nbsp;Frozen Shipped Semen?:</b></td>
  		                        <td width="65%"><cfif #get_Item.frozen_semen# is "A">Available<cfelse>Not Available</cfif></td>
  		                      </tr>
  		                     <tr>
  		                     ...
  		                     <tr>
  		                        <td width="35%"><b>&nbsp;&nbsp;Registration Number:</b></td>
  		                     ...
  		                     <tr>
  		                        <td width="35%"><b>&nbsp;&nbsp;Year Foaled:</b></td>
  		                        <td width="65%">#get_Item.year_foaled#</td>
  		                      </tr>
  		                  </table>
  		                </td></tr>   
  		              </table>      
  		           ...
  		           <td width="351" valign="top">
                      <table width='351' border="1" cellpadding="0" cellspacing="0">
  		                 <tr><td align="center"><b><br>
  		                    <font color="CDC8AB"><img src="#VAROOT#/images/clock.gif" height=16 width=16>&nbsp;&nbsp;Time Remaining:</font><br>
		                    <cfif #get_Item.status# EQ 1 AND #get_Item.date_end# GT #TIMENOW#>
		                       <font size=4><b>#timeleft#</b></font>
		                    <cfelseif #get_HighBid.winner# EQ 1 OR #get_HighBid.buynow# EQ 1>
                               <font size=10 color="red"><b>SOLD</b></font>   
                            <cfelse>
                               <font size=6 color="red"><b>EXPIRED<br>(NOT SOLD)</b></font>                            
		                    </cfif>   
  		                    <br><br>
  		                 </td></tr>
 	                  </table>   
                      ...
                      <table width='100%' border="1" cellpadding="0" cellspacing="0">
                        ...
                        <table width='100%' border="0" cellpadding="5" cellspacing="5">
                           <cfif #get_Item.buynow_price# GT 0>
	                          ...
	                          <cfif #get_Item.status# EQ 1 AND #from_list# LTE 1>
                      ...
                      <table width='100%' border="1" cellpadding="0" cellspacing="0">
                        ...
                        <table width='100%' border="0" cellpadding="3" cellspacing="3">
	                      ...
	                      <tr>
  		                  ...
  		                  <tr><td colspan=2 align="center"><a href="bidhistory.cfm?itemnum=#itemnum#&curr_cat=#curr_cat#&curr_lvl=#curr_lvl#"><font size=1></font>View Bid History</font>&nbsp;(#get_HighBid.RecordCount#)</a></td></tr>
                          ...
                          <cfif #get_Item.status# EQ 1 AND #from_list# LTE 1>		                  
  		                     <tr><td colspan=2 align="center"><input type="submit" name="reviewBid" value="Review Bid"></td></tr>
  		                  </cfif>   
  		                </table>   
  		                </td></tr>
  		              </table>
                      ...
                      <table width='100%' border="1" cellpadding="0" cellspacing="0">
  		                 <tr><td align="center">
                             ...
                             <table width='80%' border="0" cellpadding="0" cellspacing="0">
  		                        <tr><td><img src="#VAROOT#/images/list.gif" height=14 width=14>&nbsp;&nbsp;<a href="../../under_const.cfm"><b>Add to watch list</b></a></td></tr>
  		                        <tr><td><img src="#VAROOT#/images/friend.gif" height=14 width=14>&nbsp;&nbsp;<a href="mailto:your friend email?subject=#get_Item.name#&body=Thought you might be interested on #get_Item.name# on auction"><b>Tell a friend</b></a></td></tr>
  		                        <tr><td><img src="#VAROOT#/images/share.gif" height=14 width=14>&nbsp;&nbsp;<a href="../../under_const.cfm"><b>Share this</b></a></td></tr>
  		                     </table>   
  		                     <br>
  		                 </td></tr>
 	                  </table>   
 	                  <br>
                      <table width='100%' border="1" cellpadding="0" cellspacing="0">
  		                <tr bgcolor="616362"><td align="center"><font size=4><b>Seller Info</b></font></td></tr>
                        <tr><td>
                        <table width='100%' border="0" cellpadding="0" cellspacing="5">
  		                  <tr><td align="center"><a href="mailto:#get_seller_email.email#?subject=#get_Item.name#"><b>#get_Item.nickname#</b></a><a href="#VAROOT#/feedback/index.cfm?user_id=#get_Item.user_id#&itemnum=#get_Item.itemnum#&curr_cat=#curr_cat#&curr_lvl=#curr_lvl#">&nbsp;(<b>#ratingSeller#</b>)</a></td></tr>
  		                  <tr><td align="center"><font size=2>Phone:&nbsp;#get_Item.user_phone#</font></td></tr>
  		                  <tr><td align="center"><font size=2>#get_Item.user_addr#</font></td></tr>
  		                  <tr><td align="center"><font size=2>#get_Item.user_city#&nbsp;#get_Item.state#</font></td></tr>
  		                  <tr><td align="center"><font size=2>#get_Item.user_country#</font></td></tr>
  		                  ...
  		                  <tr><td align="center">
                             <table width='90%' border="0" cellpadding="0" cellspacing="0">
                                <tr><td><a href="#VAROOT#/feedback/legend.cfm?">
  		                        ...
  		                        <tr><td><img src="#VAROOT#/images/contact.gif" height=14 width=14>&nbsp;&nbsp;<a href="mailto:#get_seller_email.email#?subject=#get_Item.name#"><b>Contact Seller</b></a></td></tr>
  		                        <tr><td><img src="#VAROOT#/images/web.gif" height=14 width=14>&nbsp;&nbsp;<a href="#get_Item.weblink#" target="_blank"><b>Web Site</b></a></td></tr>
  		                        <tr><td><img src="#VAROOT#/images/terms.gif" height=14 width=14>&nbsp;&nbsp;<a href="##" onClick="view_terms(#itemnum#)"><b>View Seller's Terms</b></a></td></tr>
  		                     </table>   
  		                     <br>
  		                  </td></tr>            
  		                </table>   
		         ...
		         <tr><td colspan=3>&nbsp;</td></tr>
                     ...
                     <table width='100%' border="1" cellpadding="0" cellspacing="0">
                        ...
                        <tr><td align="center">
                            <table width='98%' border="0" cellpadding="5" cellspacing="5">
                               ...
                               <tr align="center">
                                 <td><cfif #get_Item.picture1# is not ""><img src="#VAROOT#/fullsize_thumbs/#get_Item.picture1#" border=1 height=250 width=250><cfelse>&nbsp;</cfif></td>
                                 <td><cfif #get_Item.picture2# is not ""><img src="#VAROOT#/fullsize_thumbs1/#get_Item.picture2#" border=1 height=250 width=250><cfelse>&nbsp;</cfif></td>
                                 <td><cfif #get_Item.picture3# is not ""><img src="#VAROOT#/fullsize_thumbs2/#get_Item.picture3#" border=1 height=250 width=250><cfelse>&nbsp;</cfif></td>
                               </tr>  
                               <tr align="center">
                                 <td><cfif #get_Item.picture4# is not ""><img src="#VAROOT#/fullsize_thumbs3/#get_Item.picture4#" border=1 height=250 width=250><cfelse>&nbsp;</cfif></td>
                                 <td><cfif #get_Item.picture5# is not ""><img src="#VAROOT#/fullsize_thumbs4/#get_Item.picture5#" border=1 height=250 width=250><cfelse>&nbsp;</cfif></td>
                                 <td><cfif #get_Item.picture6# is not ""><img src="#VAROOT#/fullsize_thumbs5/#get_Item.picture6#" border=1 height=250 width=250><cfelse>&nbsp;</cfif></td>
                               </tr>  
  		                    </table>
                        </td></tr>
  		             </table>      
  		         ...
  		         <cfif #terms# is not "">
  		            ...
  		            <tr><td colspan=3>
                        <table width='100%' border="1" cellpadding="0" cellspacing="0">
                           <tr bgcolor="616362"><td align="center"><font size=4><b>Terms of Sale</b></font></td></tr>
                           <tr><td align="center">
                           <table width='98%' border="0" cellpadding="5" cellspacing="5">
                              <tr><td>#terms#</td></tr>
	                       </table>
