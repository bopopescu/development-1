...
<cfif #isDefined ("view_type")#>
   <cfset view_type = #view_type#>
<cfelse>
   <cfset view_type = 0>
</cfif>
		  ...
		  <td width=160 valign="top">
	             ...
	             <tr><td align="left">
    		        ...
    		        <cfloop query="get_Categories">
		               ...
		               <li>
		                  <font size=2 color="CDC8AB"><a href="index.cfm?curr_cat=#category#&curr_lvl=#this_lvl#&from_search=#from_search#&view_type=0">#name#
	                ...
	                <tr><td>&nbsp;</td></tr>
	                <cfif #view_type# EQ 0 AND #curr_lvl# EQ 0>
	                   <tr><td align="center"><font size=1><a href="index.cfm?curr_cat=0&curr_lvl=0&from_search=#from_search#&view_type=1">VIEW ALL CATEGORIES</a></td></tr>
	                </cfif>   
	                <tr><td>&nbsp;</td></tr>
