...
<cfif #trim(submit)# is "Post New Horse">
     <cflocation url="#VAROOT#/sell/index.cfm?gencat=S<!---&curr_cat=S&curr_lvl=0--->&from_search=0">
</cfif>

<!---Top 10 Auctions Button at the top of Page--->
<cfif #trim(submit)# is "Top 10 Auctions">
     <cflocation url="#VAROOT#/index.cfm?gencat=A&curr_cat=S&curr_lvl=0&from_search=0">
</cfif>
 <!---<cfif #gencat# EQ "S">
...
<!---Beginning of Top Sub Menu--->
		...
		<!--- JM Post New Horse Top Button--->
                 ...
                 <form name="listings" action="index.cfm">
                   <cfif #curr_lvl# EQ 0>
	                  <tr><td colspan=3 align="Left"><input type="submit" name="submit" value="Post New Horse">
					  								 <input type="submit" name="submit" value="Top 10 Auctions"></td></tr>
	               </cfif>  
	             </form>
		 <td>&nbsp;</td>
		...
		<table width='100%' cellpadding="0" cellspacing="0" style="border-color: CDC8AB; border-width: 1px:">
		  ...
		  <td width=350 valign="top">
    		     ...
    		     <cfelse>
	              ...
	              <!--- JM Post New Horse Body Button--->
				  	<!---Tagged this out for and example of using values--->
                 ...
                 <form name="listings" action="index.cfm">
                   ...
                   <cfif #curr_lvl# GT 0>
	                  <tr><td colspan=3 align="center"><input type="submit" name="submit" value="Post New Horse"></td></tr>
	               </cfif>   
	             </form>--->
		  ...
		  <td width=645 valign="top">
		         ...
		         <td>&nbsp;</td>
		         <td width=95 align="center"><font color="CDC8AB"><b>Buy Now</b></font></td>
		         <td>&nbsp;</td>
  					...
  					<cfset timeleft = hrsleft & "" & hrslabel & " " & minsleft & "" & minslabel & " +">
	                   ...
	                   <td align="left"><font size=3><a href="../listings/details/index.cfm?itemnum=#itemnum#&curr_cat=#curr_cat#&curr_lvl=#curr_lvl#&from_list=0">#name# <br><font size=2> (Entry:#itemnum#)<br>
							  ...
							  <cfif #get_Bids.winner# NEQ 1 AND #get_Bids.buynow# NEQ 1 AND #buynow_price# GT 0 AND #buynow_price# GT get_maxbid.max_bid >
                               <font size=2 color=00FF00><i><b>BUY NOW</b>&nbsp;<b>AVAILABLE</b></i><br>
