...
<cfquery username="#db_username#" password="#db_password#" name="get_Categories" datasource="#DATASOURCE#">
    SELECT category, name, date_created, child_count, count_total
      FROM categories
     WHERE lvl_2 = #subcat1# AND category <> #subcat1#
       AND active = 1
       AND require_login = 0
     ORDER BY name ASC
</cfquery>
	...
	<td align="center">
		...
		<table border='1' width='980' cellpadding="0" cellspacing="0">
		  <tr><td colspan=13 align="left">
		      <font size=4 color="CDC8AB"><b>&nbsp;#get_CatName.name#</b></font><font size=3 color="CDC8AB"><b> - Sub-category Listings</b></font><br>
		      <font size=2 color="CDC8AB">&nbsp;You may browse <b>Sub-categories</b> for a more definite results or use <a href="../under_const.cfm"><b>Search</b></a> to find a specific listing.</font>
	      </td></tr>
		  <td width=160 valign="top">
   		      <table width='100%' cellpadding="0" cellspacing="0">
		         <tr bgcolor="616362"><td align="center"><font color="CDC8AB"><b>Sub-categorie(s)</b></font></td></tr>
	             ...
	             <center>
    		        ...
    		        <cfloop query="get_Categories">
		               ...
		               <tr><td align="left"><li><font size=2 color="CDC8AB"><a href="../under_const.cfm">#name#&nbsp;(<b>#get_totals.total_items#</b>)</a></font></li></td></tr>
    		        </cfloop>
	                ...
	                <tr><td>&nbsp;</td></tr>
	                <tr><td><font color="CDC8AB" size=2>Note: Lisiting may exist in sub-categories.</font></td></tr>
    		     <cfelse>
 	                <tr><td>&nbsp;</td></tr>
	                <tr><td align="center"><font color="CDC8AB" size=2>No sub-categories found.</font></td></tr>
	             </cfif>   
                 <tr><td>&nbsp;</td></tr>
                 <form action="../listings/index.cfm?gencat=#gencat#&cat=#cat#">
                   <input type="hidden" name="gencat" value="#gencat#">
		  ...
		  <td width=740 valign="top">
		         ...
		         <td>&nbsp;</td>
		         <td width=120 align="center"><font color="CDC8AB"><b>Current Bid</b></font></td>
		         <td>&nbsp;</td>
		         <td width=120 align="center"><font color="CDC8AB"><b>Sire</b></font></td>
		         <td>&nbsp;</td>
		         <td width=60 align="center"><font color="CDC8AB"><b>Bids</b></font></td>
		         <td>&nbsp;</td>
		         <td width=70 align="center"><font color="CDC8AB"><b>Reserve Price</b></font></td>
		         <td>&nbsp;</td>
