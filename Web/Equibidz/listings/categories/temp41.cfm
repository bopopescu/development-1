...
<table border="0" cellpadding="0" cellspacing="0" width="856" align="center">
<tr valign="top">
...
<cfif isdefined("session.user_id") and session.user_id neq "" and isdefined("session.password") and session.password neq ""><a href="#VAROOT#/login.cfm?logout=1" ><font color=red><img src="#varoot#/images/e01.gif" width="8" height="7" alt="" border="0">&nbsp;&nbsp;Logout</a></font></a><cfelse><a href="#VAROOT#/login.cfm?login=1"><img src="#varoot#/images/e01.gif" width="8" height="7" alt="" border="0">&nbsp;&nbsp;Login</a></cfif></p>
</td>
</tr>
</table>
	</td>
...
<p class="px5">
<table border="0" cellpadding="0" cellspacing="0" width="95%" align="center" height="10" background="images/fon_bar01.gif">
<tr><td><table><tr>
</cfoutput>
