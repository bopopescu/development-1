...
<cfset counter=1> 
		  ...
		  <table border=2 cellspacing=0 cellpadding=0 bordercolor="#get_colorInfo.heading_color#">
...
<table border=0 bgcolor="#get_colorInfo.bg_color#" cellpadding="5">
