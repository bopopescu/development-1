...
<cfoutput>			<table cellpadding=2 border=0 width="100%"> 			 	<TR>                <td WIDTH=100% style="color:#heading_fcolor#; font-family:#heading_font#;font-size:#heading_font_size#px;" align=center>
...
</td>    				</TR>                  <tr>                    <td align=center>				    					<font color = #heading_color#><B>					<cfif #new_users.recordcount#>						Welcome our Newest Members!<br>						<cfloop query="new_users">						<a href="#VAROOT#/messaging">	<font color=red><i>						#nickname#						</i></font></a>						<br>						</cfloop>					<cfelse>					</cfif>					</font>					</td>                  </tr>							</table>			</cfoutput>
