...
<cfset current_page="sell">
 ...
 <cfinclude template="../includes/app_globals.cfm">
  ...
  <!--- def vals --->
  <cfset sDescAddendumNote = '<br><br><hr size=2 color=#heading_color# width=100%><font face="helvetica">On #DateFormat(Now(), "mm/dd/yyyy")# at #TimeFormat(Now(), "HH:mm:ss")#, advertiser added the following information:</font><br><br>'>
...
<!---       <cfmodule template="../functions/addTransaction.cfm"
    ...
    <cfoutput><cflocation url="edit_info.cfm?selected_category=#selected_category#&submit=expand&selected_ad=#selected_ad#&submit3=Another"></cfoutput>
  </cfif>
...
<FONT SIZE=2><cfinclude template="../includes/menu_bar.cfm"></FONT></center><br><br></td></tr>
          ...
          <table border=0 cellspacing=0 cellpadding=5 width=100%>
           ...
           <tr>
            <td valign="top"><!-- This is a test Comment, Top of form  -->
             <form name="adform" action="edit_info.cfm" method="post">          
...
<!---                   <tr>
 ...
 --->
                  ...
                  <tr>
                   <td colspan=4><hr size=2 color=#heading_color# width=100%></td>
                  </tr>
                  <tr>
                   <td colspan=4><hr size=2 color=#heading_color# width=100%>></td>
                  </tr> 
                  <tr>
				   ...
				   <!---<input type="submit" name="submit3" value="Edit Another" width=75>&nbsp;---><cflocation url="edit_pre_new.cfm?submit=enter&selected_ad=#session.adnum#">
