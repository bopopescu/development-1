...
<cfif isDefined("category")>
   <cfset category = #selected_category#>
<cfelse>
   <cfif isDefined("session.category") AND #submit# NEQ 0>
      <cfset category = #session.category#>
   <cfelse>   
      <cfset category = #gencat#>
   </cfif>   
</cfif>
...
<cfif isDefined("auction_mode") is "">
...
<script language="JavaScript">
	...
	function getAuctionMode( vAuction){
		if (vAuction == 0) {
			document.theFlag.src="../images/r_reverse_blank.gif";
		    tr = document.getElementById( "trMIN" );
		    tr.style.display = "table-row";
  	        tr = document.getElementById( "trMAX" );
	        tr.style.display = "none";
	        tr = document.getElementById( "trBUY" );
	        tr.style.display = "table-row";
	...
	function val_entries() {
        var xAuction = document.listForm.selected_auction_mode.selectedIndex;
	...
	<form name="listForm" action="index.cfm" method="post" enctype="multipart/form-data">
	    ...
	    <tr><td>
 	    <table border=0 width=800 cellpadding="2" cellspacing="2">        
           <tr>
               <td><font size=3><b>*General Classification:</b></font></td>
                   <td>&nbsp;</td>   
                   <td>
                     <select name="selected_category">
                      <option value="S"<cfif #category# is "S"> selected</cfif>>Stallions</option>
                      <option value="M"<cfif #category# is "M"> selected</cfif>>Mares</option>
                      <option value="G"<cfif #category# is "G"> selected</cfif>>Geldings</option>
                    </select>&nbsp;<font size=3>(for Main Menu classification purpose only)</font>
               </td>
           </tr>
           <tr>
           ...
           <tr><td><font size=3><b>Year Foaled:</b></font></td>
               <td>&nbsp;</td>                   
           ...
           <tr><td colspan=3><hr size=1 color="616362" width=100%></td></tr> 
           <tr><td colspan=3><font size=2>Only JPG (not progressive) and GIF images are supported. (Height:480 X Width:440)</font></td></tr>
		   <tr>
           ...
           <tr><td><font size=3><b>Province:</b></font></td>
               <td>&nbsp;</td>                   
           ...
           <tr><td><font size=3><b>Terms of Sale:</b></font></td>
               <td>&nbsp;</td>                   
               <td><input type="reset" name="submit" value=" Input Terms of Sale " onClick="get_terms(#itemnum#)"></td>
           </tr>
           <tr><td colspan=3><hr size=1 color="616362" width=100%></td></tr> 
           <tr>
           ...
           <tr><td><font size=3><b>Sales Tax:</b></font></td>
               <td>&nbsp;</td>                   
