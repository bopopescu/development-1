...
<tr valign="top">
	...
	<table border='0' width="900" cellpadding="0" cellspacing="0">
	  ...
	  <table border='0' width='900' cellpadding="0" cellspacing="0">
	    <tr>
	    <td width="50%" valign="top">This is a preview of how your item will look like onced it is posted. Plase make sure that all information shown are correct before comitting to submit this item.<br><br>Note: This Auction is subject to the  <a href="../terms.cfm">Terms & Conditions</a> of &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;equibidz.com as well as the fee charges.</font></td>
	    <td width="15%">&nbsp;</td>
	  ...
	  <tr><td align="center">
	      ...
	      <tr><td align="center"><br>
	          <font size=3 color="CDC8AB"><b>&nbsp;Category:&nbsp;&nbsp;&nbsp;#get_CatName.name#</b></font><br>
 		      <font size=4 color="CDC8AB"><b>#session.name#&nbsp;(Entry: #itemnum#)&nbsp;&nbsp;#session.list_type#</b></font><br><br>
  		              ...
  		              <table width='100%' cellpadding="0" cellspacing="0">
  		                 <tr><td align="center">
  		                    <table width='500' cellpadding="0" cellspacing="0">  	
  		                       <cfif #session.picture1# is not "">
  		                          <tr><td align="center" valign="center"><img src="#VAROOT#/fullsize_thumbs/#session.picture1#" border=1 height=300 width=380></td></tr>
  		                       <cfelse>
  		                 ...
  		                 <tr><td>&nbsp;</td></tr>
  		                 <tr><td align="center"><b>#trim(session.name)#&nbsp;#trim(session.pri_breed)#&nbsp;#trim(session.year_foaled)#&nbsp;#trim(session.color)#</b></td></tr>
  		                 <tr><td>&nbsp;</td></tr>   
  		                 <tr><td>
                        ...
                        <tr><td>
                          <table width='100%' border="0" cellpadding="3" cellspacing="5">
                             ...
                             <tr>
                                ...
                                <td width="65%">#session.city#&nbsp;#session.state#&nbsp;USA</td>
  		                     </tr>  		                     
  		                     <tr>
  		                     ...
  		                     <tr>
  		                        ...
  		                        <td width="65%"><cfif #session.shipped_semen# is "A">Available<cfelse>Not Available</cfif></td>
  		                      </tr>
  		                     <tr>
  		                        <td width="35%"><b>&nbsp;&nbsp;Frozen Shipped Semen?:</b></td>
  		                        <td width="65%"><cfif #session.frozen_semen# is "A">Available<cfelse>Not Available</cfif></td>
  		                      </tr>
  		                     <tr>
  		                     ...
  		                     <tr>
  		                        ...
  		                        <td width="65%">#session.year_foaled#</td>
  		                      </tr>
  		                  </table>
  		                </td></tr>   
  		              </table>      
  		                  ...
  		                  <tr><td align="center">
                             <table width='90%' border="0" cellpadding="0" cellspacing="0">
                                <tr><td>
  		                        ...
  		                        <tr><td><img src="#VAROOT#/images/web.gif" height=14 width=14>&nbsp;&nbsp;<b>Web Site</b></td></tr>
                     ...
                     <table width='100%' border="1" cellpadding="0" cellspacing="0">
                        ...
                        <tr><td align="center">
							<table width='98%' border="0" cellpadding="5" cellspacing="5">
                               ...
                               <tr align="center">
                                 <td><cfif #session.picture1# is not ""><img src="#VAROOT#/fullsize_thumbs/#session.picture1#" border=1 height=250 width=250><cfelse>&nbsp;</cfif></td>
                                 <td><cfif #session.picture2# is not ""><img src="#VAROOT#/fullsize_thumbs1/#session.picture2#" border=1 height=250 width=250><cfelse>&nbsp;</cfif></td>
                                 <td><cfif #session.picture3# is not ""><img src="#VAROOT#/fullsize_thumbs2/#session.picture3#" border=1 height=250 width=250><cfelse>&nbsp;</cfif></td>
                               </tr>  
                               <tr align="center">
                                 <td><cfif #session.picture4# is not ""><img src="#VAROOT#/fullsize_thumbs3/#session.picture4#" border=1 height=250 width=250><cfelse>&nbsp;</cfif></td>
                                 <td><cfif #session.picture5# is not ""><img src="#VAROOT#/fullsize_thumbs4/#session.picture5#" border=1 height=250 width=250><cfelse>&nbsp;</cfif></td>
                                 <td><cfif #session.picture6# is not ""><img src="#VAROOT#/fullsize_thumbs5/#session.picture6#" border=1 height=250 width=250><cfelse>&nbsp;</cfif></td>
                               </tr>  
  		                    </table>
                            <table width='98%' border="0" cellpadding="5" cellspacing="5">
                               <cfif #session.youtube# is not "">
             ...
             <table width='100%' border="0" cellpadding="0" cellspacing="0">
               <tr>
 	           <td width="50%" align="right">
                 <form name="details" action="item_submit.cfm?itemnum=#itemnum#&curr_cat=#curr_cat#&curr_lvl=0&from_search=0" method="post">
