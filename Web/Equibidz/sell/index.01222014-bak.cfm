...
<cfset currentBid = replace("140,123,000", ",", "", "all")/>
<cfoutput>#dollarformat(currentBid)#</cfoutput>
...
<cfif isdefined("form.picture1") and form.picture1 is not "">
  ...
  <CFIMAGE ACTION="RESIZE" SOURCE="#directory##File.ServerFile#" DESTINATION="#directory##File.ServerFile#" NAME="cfimage_picture_1" HEIGHT="300" WIDTH="380" OVERWRITE="YES">
...
<cfif isdefined("form.picture2") and form.picture2 is not "">
  ...
  <!--- Note: "name" attribute for the cfimage tag should be a new variable name which the coldfusion server will use to create a struct containing information such as colormodel, height, source, etc... about the image.  Use cfdump for the variable name see see all the attributes. --->
  <CFIMAGE ACTION="RESIZE" SOURCE="#directory##File.ServerFile#" DESTINATION="#directory##File.ServerFile#" NAME="cfimage_picture_2" HEIGHT="300" WIDTH="380" OVERWRITE="YES">
  <!--- Rename full size image with item number --->
...
<cfif isdefined("form.picture3") and form.picture3 is not "">
  ...
  <!--- Note: "name" attribute for the cfimage tag should be a new variable name which the coldfusion server will use to create a struct containing information such as colormodel, height, source, etc... about the image.  Use cfdump for the variable name see see all the attributes. --->
  <CFIMAGE ACTION="RESIZE" SOURCE="#directory##File.ServerFile#" DESTINATION="#directory##File.ServerFile#" NAME="cfimage_picture_3" HEIGHT="300" WIDTH="380" OVERWRITE="YES">
  <!--- Rename full size image with item number --->
...
<cfif isdefined("form.picture4") and form.picture4 is not "">
  ...
  <!--- Note: "name" attribute for the cfimage tag should be a new variable name which the coldfusion server will use to create a struct containing information such as colormodel, height, source, etc... about the image.  Use cfdump for the variable name see see all the attributes. --->
  <CFIMAGE ACTION="RESIZE" SOURCE="#directory##File.ServerFile#" DESTINATION="#directory##File.ServerFile#" NAME="cfimage_picture_4" HEIGHT="300" WIDTH="380" OVERWRITE="YES">
  <!--- Rename full size image with item number --->
...
<cfif isdefined("form.picture5") and form.picture5 is not "">
  ...
  <!--- Note: "name" attribute for the cfimage tag should be a new variable name which the coldfusion server will use to create a struct containing information such as colormodel, height, source, etc... about the image.  Use cfdump for the variable name see see all the attributes. --->
  <CFIMAGE ACTION="RESIZE" SOURCE="#directory##File.ServerFile#" DESTINATION="#directory##File.ServerFile#" NAME="cfimage_picture_5" HEIGHT="300" WIDTH="380" OVERWRITE="YES">
  <!--- Rename full size image with item number --->
...
<cfif isdefined("form.picture6") and form.picture6 is not "">
  ...
  <!--- Note: "name" attribute for the cfimage tag should be a new variable name which the coldfusion server will use to create a struct containing information such as colormodel, height, source, etc... about the image.  Use cfdump for the variable name see see all the attributes. --->
  <CFIMAGE ACTION="RESIZE" SOURCE="#directory##File.ServerFile#" DESTINATION="#directory##File.ServerFile#" NAME="cfimage_picture_6" HEIGHT="300" WIDTH="380" OVERWRITE="YES">
  <!--- Rename full size image with item number --->
...
<body>
<cfoutput>
<table border='0' width="100%" <!--- JM style="background-image: url('#VAROOT#/images/bg_table.jpg') --->" cellpadding="0" cellspacing="0">
<tr><td><br></td></tr>
<tr valign="top">
	<td align="center">	
	<!--- Start: Main Body --->
