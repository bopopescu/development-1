...
<!--- customize vals --->
<cfset sNewTableName = "payments">      <!--- req., name of new table --->
...
<cfset iNumNewIndexes = 3>      <!--- req., num of new indexes for table --->
...
<cfset sNewTableIndexes = StructNew()>      <!--- all opt., if iNumNewIndexes IS 0, else req. --->
  <cfset temp = StructInsert(sNewTableIndexes, "MSAccess1", "
      CREATE INDEX itemnum_index ON #Variables.sNewTableName# (itemnum);
  ")>
  <cfset temp = StructInsert(sNewTableIndexes, "MSAccess2", "
      CREATE INDEX date_posted_index ON #Variables.sNewTableName# (date_posted);
  ")>
  <cfset temp = StructInsert(sNewTableIndexes, "MSAccess3", "
      CREATE INDEX user_id_index ON #Variables.sNewTableName# (user_id);
  ")>
