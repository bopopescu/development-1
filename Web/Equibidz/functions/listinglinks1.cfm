...
<cfif Attributes.listingtype IS "current">
  ...
  <cfset tail = "</b>">
<cfelse>
  <cfset head = '<a href="#Attributes.VAROOT#/listings/categories/index5.cfm?category=#Attributes.category#">'>
  <cfset tail = '</a>'>
</cfif>
...
<cfif Attributes.listingtype IS "new">
  ...
  <cfset tail = "</b>">
<cfelse>
  <cfset head = '<a href="#Attributes.VAROOT#/listings/categories/index5.cfm?category=#Attributes.category#&listing=new">'>
  <cfset tail = '</a>'>
</cfif>
...
<cfif Attributes.listingtype IS "ending">
  ...
  <cfset tail = "</b>">
<cfelse>
  <cfset head = '<a href="#Attributes.VAROOT#/listings/categories/index5.cfm?category=#Attributes.category#&listing=ending">'>
  <cfset tail = '</a>'>
</cfif>
...
<cfif Attributes.listingtype IS "completed">
  ...
  <cfset tail = "</b>">
<cfelse>
  <cfset head = '<a href="#Attributes.VAROOT#/listings/categories/index5.cfm?category=#Attributes.category#&listing=completed">'>
  <cfset tail = '</a>'>
</cfif>
...
<cfif Attributes.listingtype IS "going">
  ...
  <cfset tail = "</b>">
<cfelse>
  <cfset head = '<a href="#Attributes.VAROOT#/listings/categories/index5.cfm?category=#Attributes.category#&listing=going">'>
  <cfset tail = '</a>'>
</cfif>
