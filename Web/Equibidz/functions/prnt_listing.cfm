...
.clipin{
  position:absolute;
  clip:rect(0px 124px 110px 0px);/* Top,Right,Bottom,Left */
  top:0px;
  left:0px;
}
</style>
...
<cfif isDefined('Attributes.itemnum')>
  <cfquery username="#Attributes.db_username#" password="#Attributes.db_password#" NAME="getMode" DATASOURCE="#Attributes.DATASOURCE#">
    SELECT auction_mode, featured_studio, status, studio,date_end
      FROM items
...
<!--- Active ******************************************************** --->
      <cfset theThumb = "<td align=center><table bgcolor=000000><tr><td align=center valign=center><div class=clipout><div class=clipin><a href=#Attributes.VAROOT#/listings/details/index.cfm?itemnum=#Attributes.itemnum#><IMG src=#Attributes.varoot#/thumbs/#Attributes.itemnum#.jpg width=#Img_width#  border=0></a></div></div></td></tr></table></td>">
<!--- ******************************************************** --->
...
<!---
<!--- ******************************************************** --->
      <cfset theThumb = "<td align=center><table bgcolor=000000><tr><td align=center width=64 height=64><a href=#Attributes.VAROOT#/listings/details/index.cfm?itemnum=#Attributes.itemnum#><IMG src=#Attributes.varoot#/thumbs/#Attributes.itemnum#.gif width=#Img_width#  border=0></a></td></tr></table></td>">
<!--- ******************************************************** --->
--->
</cfif>
  ...
  <cfif #getMode.studio# IS 1 and #Attributes.show_thumbs# IS 1>
    ...
    <!------><tr #rowcolor#>#theThumb#<td width=356>
	<a href="#Attributes.VAROOT#/listings/details/index.cfm?itemnum=#Attributes.itemnum#">
	<font color=green><b><i>#attributes.itemnum#</i></b></font></a>&nbsp;&nbsp;#new_icon#
	<a href="#Attributes.VAROOT#/listings/details/index.cfm?itemnum=#Attributes.itemnum#">#boldstart##Trim(Attributes.itemtitle)##boldend#</a>
	#reverse##pht_icon##snd_icon#
	  <cfif check_buynow.buynow eq 1>
	    <cfif price lte check_buynow.buynow_price>
		  &nbsp;<img src="#Attributes.VAROOT#/images/buynow.gif" border="0">
		</cfif>
	  </cfif>#ban_info#</td><td width=90 align=right valign=middle><b>#price#</b></td>
	  <td width=40 align=center valign=middle>#bids#</td>
	  <td width=90 align=center valign=middle><font color=red><b>#timeleft#</font>

<!--- ends ---></td></tr>
  <cfelse>

    <tr #rowcolor#><td>&nbsp;</td><td width=480><a href="#Attributes.VAROOT#/listings/details/index.cfm?itemnum=#Attributes.itemnum#"><font color=green><b><i>#attributes.itemnum#</i></b></font></a>&nbsp;&nbsp;#new_icon#<a href="#Attributes.VAROOT#/listings/details/index.cfm?itemnum=#Attributes.itemnum#">#boldstart##Trim(Attributes.itemtitle)##boldend#</a>#reverse##pht_icon##snd_icon#<cfif check_buynow.buynow eq 1><cfif price lte check_buynow.buynow_price>&nbsp;<img src="#Attributes.VAROOT#/images/buynow.gif" border="0"></cfif></cfif>#ban_info#</td><td width=90 align=right valign=middle><b>#price#</b></td><td width=40 align=center valign=middle>#bids#</td><td width=90 align=center valign=middle>

<!---
ends ---><font color=red><b>#timeleft#</font></td></tr>
  </cfif>
  </cfoutput>
