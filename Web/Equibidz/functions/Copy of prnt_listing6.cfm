...
<td width=50 align=center valign=middle><a href="#Attributes.VAROOT#/feedback/leavefeedback.cfm?user_id=#gethighbidder.user_id#&itemnum=#attributes.itemnum#" target=_blank><font size=1>Leave<br>feed<br>back</font></a></td>	<td width=80 align=center valign=middle>#started#</td>
	<td width=80 align=center valign=middle>#ends# CST</td>
	<td width=80 align=center valign=middle><a href="http://www.mightybids.com/personal/relist_info.cfm?itemnum=#attributes.itemnum#&submit=continue">#attributes.itemnum#</a></td>
