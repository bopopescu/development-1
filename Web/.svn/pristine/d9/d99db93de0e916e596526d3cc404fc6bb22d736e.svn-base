...
<!--- Delete tmp and map files from root --->
 ...
 <cfset directory = #GetDirectoryFromPath(curPath)#>
  <cfif curPath contains "event5">
 <cfset #directory# = Replace(GetDirectoryFromPath("#curPath#"),"event5\","")>
...
<!--- Delete Category tmp and map files--->
  ...
  <cfset directory = #GetDirectoryFromPath(curPath)#>
  <cfif curPath contains "event5">
 <cfset #directory# = Replace(GetDirectoryFromPath("#curPath#"),"event5\","listings\categories\")>
<cfelseif curPath contains "admin">
...
<!--- Delete listings tmp and map files --->
  <cfset directory = #GetDirectoryFromPath(curPath)#>
  <cfif curPath contains "event5">
 <cfset #directory# = Replace(GetDirectoryFromPath("#curPath#"),"event5\","listings\")>
<cfelseif curPath contains "admin">
...
<!--- Delete featured tmp and map files --->
  ...
  <cfset directory = #GetDirectoryFromPath(curPath)#>
  <cfif curPath contains "event5">
 <cfset #directory# = Replace(GetDirectoryFromPath("#curPath#"),"event5\","listings\featured\")>
<cfelseif curPath contains "admin">
