...
<table cellpadding=2  border=0 valign="top" width=100%>
		 	<!--- What 's New --->
    		<cfoutput>
			<tr>
...
<cfoutput>			<a href="#VAROOT#/news.cfm">#left(get_news.news,100)#</a></cfoutput>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;			<a href="<cfoutput>#VAROOT#</cfoutput>/news.cfm"><font color=red> >>More News</font></a>
