...
<cfif #isDefined ("form.banner_enable")# is 1>
...
<cflocation url="submitbanner.cfm?ID=#id#">
<cfelse>
...
<form action="submitbanner.cfm" method="post" enctype="multipart/form-data">
<cfoutput query="banner2">
<table border="0" bgcolor="bac1cf" cellspacing="0" cellpadding="2" align=center>


<tr>
<td align=center>

You can change the company name, the URL link, upload a new banner, as well as enable or disable an existing banner (uncheck the check box to disable the banner. The banner will no longer displayed on the site once it's disable).
</td>
...
<tr>
	...
	<td align=center><font face="Arial,Verdana" size="2" color="Navy"><b> Company name: <input type="text" name="company" value="#company#" size="25" maxlength="50"></b></font></td>
</tr>
<tr>
...
<td align=center>
	<cfif #file_name# is "">
	<img src="../admin/images/noimage1.gif" border="0">
	<cfelse>
	<a href="#webaddress#"><img src="../banners/#file_name#" border="0"></a></cfif></td>
</tr>
<input type="hidden" name="username" value=" ">
<input type="hidden" name="password" value=" ">
<input type="hidden" name="old_file_name" value="#file_name#">

	<td align=center><font face="Arial,Verdana" size="2" color="Navy"><b>Banner URL :</b> <a href="#webaddress#">#webaddress#</a><br><input type="text" name="webaddress" value="#webaddress#" size="40" maxlength="120"></font></td>
</tr>
<tr>
    <td align=center><font face="Arial,Verdana" size="2" color="Navy"><b>Upload Banner:</b></font><br>
    <input name="file_name" type="file" size=43 maxlength=250 value="#file_name#"></td>
</tr>
<tr>
	<td align=center><font face="Arial,Verdana" size="2" color="Navy"><b>Frequency:</b></font> <input type="text" name="factor" value="#factor#" size="2" maxlength="2">&nbsp;&nbsp; <font face="Arial,Verdana" size="1" color="Red">The Higher the Number The More Often Displayed.</font><br>
