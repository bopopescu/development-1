...
<cfelseif Attributes.part IS "LISTING">
  ...
  <!--- <cfset price = "<b>" & DecimalFormat(Attributes.highest) & "</b>"> --->
    <!--- <cfset price = DecimalFormat(Attributes.highest)> --->
	<!--- set price --->
...
<cfquery username="#db_username#" password="#db_password#" name="temsp" datasource="#DATASOURCE#">
 ...
 <cfquery username="#db_username#" password="#db_password#" name="tems" datasource="#DATASOURCE#">
   update items
   set seller='#get_seller_info.nickname#'
   WHERE itemnum = #Attributes.itemnum#
  ...
  <!--- <cfif #Attributes.featured_studio# IS 1 and #Attributes.show_thumbs# IS 1>
     <tr#rowcolor#>#theThumb# 
	  <td width=206>&nbsp;#new_icon#
<a href="#Attributes.VAROOT#/listings/details/index.cfm?itemnum=#Attributes.itemnum#">#boldstart##Attributes.itemnum##boldend#</a><br>

<a href="#Attributes.VAROOT#/listings/details/index.cfm?itemnum=#Attributes.itemnum#">#boldstart##Trim(Attributes.itemtitle)##boldend#</a>#reverse##pht_icon##snd_icon#<cfif check_buynow.buynow eq 1>&nbsp;<img src="#VAROOT#/images/buynow.jpg" border="0"></cfif>#ban_info#</td>
  ...
  <cfelse> --->
    <tr#rowcolor#>
	<!--- <td width="124">&nbsp;</td>  --->
	<td width=120>&nbsp;#new_icon#<a href="#Attributes.VAROOT#/listings/details/index.cfm?itemnum=#Attributes.itemnum#">#boldstart##Attributes.itemnum##boldend#</a><br><a href="#Attributes.VAROOT#/listings/details/index.cfm?itemnum=#Attributes.itemnum#">#boldstart##Trim(Attributes.itemtitle)##boldend#</a>#reverse##pht_icon##snd_icon#<cfif check_buynow.buynow eq 1>&nbsp;<img src="#VAROOT#/images/buynow.jpg" border="0"></cfif>#ban_info#</td>
	<td width=80 align=center valign=middle>#ends#</td>
	<td width=80 align=center valign=middle>#price#</td>
	<td width=80 align=center valign=middle>#qty#</td>
	<td width=80 align=center valign=middle><a href="../feedback/leavefeedback.cfm?user_id=#get_seller_info.user_id#&itemnum=#Attributes.itemnum#">#get_seller_info.nickname#</a></td>
