...
<link rel=stylesheet href="#VAROOT#/includes/stylenew.css" type="text/css">		
				...
				<script type="text/javascript">
						...
						window.open("admin/advertisementinfo.cfm","AdinfoWindow","status=no,scrollbar=yes,width=400,height=350,left=300,top=100");
							...
							<cfif isdefined("session.user_id") and session.user_id neq "" and isdefined("session.password") and session.password neq "">
									...
									<!--- User  logged in check private or member only viewing ---------->
										...
										<cfelse>
											...
											<a href="" onclick="showAdinfoWindow()"> Advertising Information</a>
