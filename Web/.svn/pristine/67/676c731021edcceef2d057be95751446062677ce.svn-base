...
<!--- Make sure images and sounds begin with http:// --->
  ...
  <cfif ListFindNoCase(form.defaultlist,"banner")>
	...
	<cfif ListFindNoCase(form.defaultlist,"state")>
		<cflock timeout="15" throwontimeout="No" name="#session.sessionID#">
...
<cfinclude template="../../includes/menu_bar.cfm">
  ...
  <div align="center">
   <table border=0 cellspacing=0 cellpadding=2 width=800>
    <tr><td><center><cfoutput><FONT SIZE=2></FONT></center></td></tr>
    <tr>
			<td>
    ...
    <tr>
     ...
     <tr valign="top"  bgcolor="##D9D9D9">
      ...
      <cfoutput> 
			<tr valign="top"  bgcolor="##D9D9D9">
 <td valign="top"><input type="checkbox" name="defaultlist" value="state" <cfif ListFindNoCase(session.defaultlist,"state")> checked </cfif>></td>
