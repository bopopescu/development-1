...
<cfquery username="#db_username#" password="#db_password#" name="get_Items" datasource="#DATASOURCE#"><!---  maxrows="#evaluate(int(group)*int(get_PageGroup.itemsperpage))#" --->
    SELECT itemnum, status, title, picture, sound, minimum_bid, maximum_bid, bold_title, featured_cat, featured_studio, banner, banner_line, date_start, date_end,buynow
      FROM items
     WHERE status = 1
and buynow=1
       AND date_start < #TIMENOW#
      ...
      <table border=0 cellspacing=0 cellpadding=0 noshade width=640>
        <tr>
		  ...
		  <cfmodule template="../../functions/sortorderlinks.cfm"
		    sortby="#sortby#"
		    action="#VAROOT#/listings/hot/index2.cfm">
            </font>
          </td>
        </tr>
      </table>
            ...
            <center>
              <font size=2>
                ...
                <cfmodule template="../../functions/pagelinks.cfm"
                  ...
                  link="#VAROOT#/listings/featured/index2.cfm?sortby=#sortby#">
              </font>
            </center>
          </td>
        </tr>
	...
	<cfcatch>
      ...
      <!--- <table border=0 cellspacing=0 cellpadding=0 noshade width=640>
        <tr>
		  ...
		  <cfmodule template="../../functions/sortorderlinks.cfm"
		    sortby="#sortby#"
		    action="#VAROOT#/listings/featured/index2.cfm">
            </font>
          </td>
        </tr>
      </table> --->
