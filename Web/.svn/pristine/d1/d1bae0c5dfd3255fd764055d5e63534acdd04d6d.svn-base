...
<cfmodule template="../../functions/countauctions_buynow.cfm"
  category="#category#"
  listings="#listing#"
...
<cfif listing IS "current">
  <cfquery username="#db_username#" password="#db_password#" name="get_Items" datasource="#DATASOURCE#" maxrows="#evaluate(int(group)*int(get_PageGroup.itemsperpage))#">
      SELECT itemnum, status, title, picture, sound, minimum_bid, maximum_bid, bold_title, featured_cat, featured_studio, banner, banner_line, date_start, date_end, auction_mode, buynow
        FROM items
...
WHERE category1 = #category#
			...
			OR cat2_lvl_1 = #category#
			OR cat2_lvl_2 = #category#
			OR cat2_lvl_3 = #category#
			OR cat2_lvl_4 = #category#
			OR cat2_lvl_5 = #category#
			OR cat2_lvl_6 = #category#
			OR cat2_lvl_7 = #category#
			OR cat2_lvl_8 = #category#)	
      ...
      <table border=0 cellspacing=0 cellpadding=0 noshade width=800>
        <tr>
          <td valign=top>
			...
			<br><b><cfoutput>#total_auctions#</cfoutput></b> item(s) found. (Please note: Auctions may exist in subcategories.)<br>
...
<CENTER>
      <TABLE cellSpacing=0 cellPadding=0 width=800  border=0>
        ...
        <TR>
          ...
          height=28><cfoutput><A 
            href="index.cfm?category=#category#"><font size=4>All auctions</font></a></cfoutput>
</TD>
          ...
          height=28>
<cfoutput><A 
            href="index5.cfm?category=#category#"><font size=4>Buynow Only</font></a></cfoutput>
...
<TD width=5 bgColor=#ffffff></TD>
          ...
          height=28>
<cfoutput><A 
            href="index7.cfm?category=#category#"><font size=4>Studio Items</font></a></cfoutput>
...
<IMG height=10 
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="800" border=0>
        ...
        <TR>
          <TD width=800 height=10><IMG height=10 
            src="../../images/line.gif" 
            width=800 border=0></TD></TR></TBODY></TABLE><BR>
			...
			<font size=2>
                <cfsetting enablecfoutputonly="Yes">
                  ...
                  <cfmodule template="../../functions/listinglinks1.cfm"
                    listingtype="#listing#"
                    category="#category#"
                    VAROOT="#VAROOT#">
                <cfsetting enablecfoutputonly="No">
      ...
      <cfset item_count = 0>
      <cfset startrow = 1+(int(group-1)*int(get_PageGroup.itemsperpage))>
<cfif #get_items.recordcount# neq 0>      
      <cfloop query="get_Items" startrow=#startrow#>
            ...
            <center>
              <font size=2>
                ...
                <cfmodule template="../../functions/pagelinks.cfm"
                  thispage="#group#"
                  totalpages="#total_pages#"
                  link="#VAROOT#/listings/categories/index5.cfm?category=#category##pageLink#">
              </font>
            </center>
            <br>
            <!--- <font size=-1>
	  ...
	  <cfelse>
	  <cfsetting enablecfoutputonly="No">
	  <br><b>No auctions (Please note: Auctions may exist in subcategories.)</b>
      </cfif>
      <!--- <table border=0 cellspacing=0 cellpadding=0 noshade width=800>
        <tr>
          <td>
