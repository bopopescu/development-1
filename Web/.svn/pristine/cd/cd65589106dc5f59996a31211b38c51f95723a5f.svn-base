   ...
   <table border=0 cellspacing=0 cellpadding=2 width=800>
          <tr>
            <td>
              ...
              and your Email Account in the appropriate fields below and we will send 
              you your password via email. If the informations you entered do exist in
              our Database, then you will definitely find your password.<br>
              <br>
              <cfif not chkSubmit>
              ...
              <input type=text name="nickname" value="#Variables.nickname#" size=40><br><br>
              <font size=2>Your <b>Email Account</b></font><br>
              <input type=text name="keyword" value="#Variables.keyword#" size=40><br><br>
              <br>
