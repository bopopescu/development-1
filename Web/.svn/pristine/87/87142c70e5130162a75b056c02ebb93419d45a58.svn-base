...
<cfif #isDefined ("enable_thumbs")# is 1>
 ...
 <cfif not #isDefined ("premium")# is 1>
  <cfset #premium# = "0">
 </cfif>
 
 <cfif not #isDefined ("administrative")# >
  <cfset #administrative# = "0">
 </cfif>
 
 <cfif not #isDefined ("financial")# >
  <cfset #financial# = "0">
 </cfif>
...
<!---  <cfquery username="#db_username#" password="#db_password#" name="get_fee_percentage" datasource="#DATASOURCE#">
 ...
 <cfquery username="#db_username#" password="#db_password#" name="get_fee_banner" datasource="#DATASOURCE#">
  ...
  <cfquery username="#db_username#" password="#db_password#" name="get_premium" datasource="#DATASOURCE#">
   SELECT pair
     FROM defaults
    WHERE name='premium'
  </cfquery>
  <cfset premium = get_premium.pair>
  
  <cfquery username="#db_username#" password="#db_password#" name="get_administrative" datasource="#DATASOURCE#">
   SELECT pair
     FROM defaults
    WHERE name='administrative'
  </cfquery>
  <cfset administrative = get_administrative.pair>
  
  <cfquery username="#db_username#" password="#db_password#" name="get_financial" datasource="#DATASOURCE#">
   SELECT pair
     FROM defaults
    WHERE name='financial'
  </cfquery>
  <cfset financial = get_financial.pair>
...
<cfelse>
  ...
  <cfif administrative eq ""><cfset administrative = '0' ></cfif>
  <cfquery username="#db_username#" password="#db_password#" name="update33" datasource="#DATASOURCE#">
   UPDATE defaults
      SET pair='#administrative#'
    WHERE name='administrative'
  </cfquery>

  <!--- update buyers premium fee --->
  <cfif premium eq ""><cfset premium = '0' ></cfif>
  <cfquery username="#db_username#" password="#db_password#" name="update34" datasource="#DATASOURCE#">
   UPDATE defaults
      SET pair='#premium#'
    WHERE name='premium'
  ...
  <!--- update financial fee --->
  <cfif financial eq ""><cfset financial = '0' ></cfif>
  <cfquery username="#db_username#" password="#db_password#" name="update35" datasource="#DATASOURCE#">
   UPDATE defaults
      SET pair='#financial#'
    WHERE name='financial'
  </cfquery>
...
<!--- ******************************************************************** --->
       ...
       <tr>   
         <td colspan=5 bgcolor=bac1cf>
           <table border=1 bordercolor=000000 cellspacing=0 cellpadding=0 width=900 bgcolor="#BAC1CF">	    
             <tr>
               <td>
...
<input type="text" name="Top_seller" size=7 maxlength=255 value="#top_seller#">
				  ...
				  <tr><td colspan=3>            <hr size=1 color=#heading_color# > </td></tr>
				  <tr><td align="center" colspan=3>           <strong>Auction Item Fees</strong>  </td></tr>
				  <tr>                 
                   <td><font face="helvetica" size=2><b>Buyer's Premium</b></font></td>
                   <td align="right">&nbsp;</td>
                   <td><font face="helvetica" size=2><input type="text" name="premium" size=7 maxlength=10 value="#REReplace(premium, "[^0-9.]", "", "ALL")#"><b>%</b></td>
                  </tr>
				  <tr>                 
                   <td><font face="helvetica" size=2><b>Administrative Fee</b></font></td>
                   <td align="right"><font face="helvetica" size=2><b>$</b></td>
                   <td><input type="text" name="administrative" size=7 maxlength=10 value="#REReplace(administrative, "[^0-9.]", "", "ALL")#"></td>
                  </tr>
				  <tr>                 
                   <td><font face="helvetica" size=2><b>Financial Fee</b></font></td>
                   <td align="right"><font face="helvetica" size=2><b>$</b></td>
                   <td><input type="text" name="financial" size=7 maxlength=10 value="#REReplace(financial, "[^0-9.]", "", "ALL")#"></td>
                  </tr>
