...
<cfquery username="#db_username#" password="#db_password#" name="temsp" datasource="#DATASOURCE#">
  ...
  <!--- set bids --->
  <cfif Attributes.totalbids is not 0>
 ...
 <!---  <cfquery username="#db_username#" password="#db_password#" name="check_auction_cancel" datasource="#datasource#">
  ...
  <!--- <cfif #Attributes.featured_studio# IS 1 and #Attributes.show_thumbs# IS 1>
     <tr#rowcolor#>#theThumb# 
	  <td width=206>&nbsp;    <cfif IsNumeric(Attributes.highest) or IsNumeric(Attributes.lowest) ><img src="#attributes.varoot#/images/high.gif" border=0 title="You are the current high bidder"><cfelse><img src="#attributes.varoot#/images/low.gif" border=0></cfif>#new_icon#
...
<a href="#Attributes.VAROOT#/listings/details/index.cfm?itemnum=#Attributes.itemnum#">#boldstart##Trim(Attributes.itemtitle)##boldend#</a>#reverse##pht_icon##snd_icon#<cfif check_buynow.buynow eq 1>&nbsp;<img src="#VAROOT#/images/buynow.jpg" border="0"></cfif>#ban_info#</td>
  ...
  <cfelse> --->
    <tr#rowcolor#>
	<!--- <td width="124">&nbsp;</td>  --->
	<td width=120>&nbsp;<cfif IsNumeric(Attributes.highest) or IsNumeric(Attributes.lowest) ><img src="#attributes.varoot#/images/high.gif" title="You are the current high bidder" border=0><cfelse><img src="#attributes.varoot#/images/low.gif" border=0></cfif>#new_icon#
