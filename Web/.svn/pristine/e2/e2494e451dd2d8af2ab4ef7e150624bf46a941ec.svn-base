	    ...
	    <tr><td>
 	    <table border=0 width=800 cellpadding="2" cellspacing="2">      
           ...
           <tr>
               ...
               <td>&nbsp;</td>   
               <td>
				   <div class="addDiscipline"> <input type="textbox" id="txtdiscipline" size="50" name="selected_discipline"></div>
				   <div class="cb" id="cb">
           ...
           <tr>
               ...
               <td>
			   	   ...
			   	   <div class="addAttributes"> <input type="textbox" id="txtattributes" size="50" name="selected_attributes"></div>
           ...
           <tr id="tr2" style="display:none;">
              <td colspan=3 align="center">
				<table width="100%" border=0 cellspacing=0 cellpadding=0>
					...
					<tr><td><font size=3><b>Terms of Sales & Shipping Info</b>&nbsp;(You can paste/type document here)</font></td></tr>
