...
<cftry>
 ...
 <cfset error_message=""> 
  ...
  <cfcatch>
    <cfset hlightStart = '<font color="red">'>
    <cfset hlightEnd = '</font>'>
  </cfcatch>
</cftry>
...
<cfsetting enablecfoutputonly="No">
  ...
  <form name="addFeedback" action="my_accounts.cfm?my_No=12" method="POST">
...
<cfif chksubmit>
        <tr><td>
           Feedback submited successfully...<br><br>
           Thank you for leaving your comments about our users. We hope your stay here is an enjoyable one. The following message will now be displayed in "douglas's" feedback record.<br><br>
           <a href="my_accounts.cfm?my_No=12"><font size=3><b>Post Another Feedback</b></font></a>              
        </td></tr> 
        
        <!----
        <cfmodule template="#VAROOT#/feedback/submitcomplete.cfm"
...
<cfelse>
      ...
      <cfelse>
        <cfoutput>
        <table border=0 cellspacing=2 cellpadding=0 noshade width=600>
          <tr>
            <td>
              <font size=2>
        ...
        <table border=0 cellspacing=0 cellpadding=0 noshade width=600>
          <tr>
            <td><br>
              ...
              <input type=submit name="leave_comment" value="Submit Feedback"><br><br>
