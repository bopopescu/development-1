...
<center>
	<center><cfinclude template="#varoot#/includes/banners1.cfm"></center><br>
	<script language="JavaScript1.2" src="http://babelfish.altavista.com/static/scripts/translate_engl.js"></script>
</center>
<br>
...
<center>
	...
	<cfif getloggedin.recordcount>
		<font color=#get_layout.text_color#><b><i><a href="#varoot#/messaging/index.cfm?user_id=#getloggedin.nickname#">#getloggedin.nickname#</a></i></b></font>,
	<cfelse>
	...
	<font color=#get_layout.text_color#>
		<font color=#get_layout.text_color#>
			...
			<!---<a href="#VAROOT#/listings/Studio.cfm?/##theLink">Studio</a>&nbsp;<a href="#VAROOT#/listings/categories/index.cfm">Listings</a>&nbsp;--->
			<a href="#VAROOT#/help/index.cfm">Help</a>&nbsp;|&nbsp;
			<!--- <a href="#VAROOT#/listings/categories/all_cats.html">Sell</a>  |--->
			...
			<a href="#VAROOT#/support">FAQ</a>&nbsp;|&nbsp;
			<a href="#VAROOT#/help/sitemap.cfm">Site Map</a>&nbsp;|&nbsp;
			<a href="#VAROOT#/contactus.cfm">Contact Us</a>&nbsp;|&nbsp;
			<a href="#VAROOT#/aboutus.cfm">About Us</a>&nbsp;|&nbsp;
			<a href="#VAROOT#/privacy.cfm">Privacy</a>&nbsp;|&nbsp;
			<a href="#VAROOT#/terms.cfm">Terms and Conditions</a>&nbsp;|&nbsp;
			<a href="#VAROOT#/help/fee_schedule.cfm">Fees</a>&nbsp;|&nbsp;
			<a href="#VAROOT#/send.cfm">Suggest a Category</a>&nbsp;|&nbsp;
			<a href="#VAROOT#/reportfraud.cfm">Report Fraud</a>&nbsp;|&nbsp;
			<a href="http://babelfish.altavista.com" target=_blank>Translate This Page</a><br>
			Copyright &copy; #Year(TIMENOW)# #get_layout.COMPANY_NAME#
			<i>All Rights Reserved.</i><br>
			Use of this Web site constitutes acceptance of the <a href="#VAROOT#/registration/user_agreement.cfm">User Agreement</a>.<br><br>
			VisualAuction Copyright © 1997-#Year(TIMENOW)# <a href="http://www.beyondsolutions.com/">Beyond Solutions Inc.</a>
			<i>All Rights Reserved.</i><br>
		</font>
	</font>
</center>
