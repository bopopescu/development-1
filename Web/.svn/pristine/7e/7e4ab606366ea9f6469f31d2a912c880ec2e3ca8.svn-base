...
<cfmodule template="../../functions/countauctions_studio.cfm"
  category="#category#"
  listings="#listing#"
          ...
          <TD width=800 height=10><IMG height=10 
			...
			<font size=2>
                <cfsetting enablecfoutputonly="Yes">
                  ...
                  <cfmodule template="../../functions/listinglinks2.cfm"
                    listingtype="#listing#"
                    category="#category#"
                    VAROOT="#VAROOT#">
                <cfsetting enablecfoutputonly="No">
            ...
            <center>
              <font size=2>
                ...
                <cfmodule template="../../functions/pagelinks.cfm"
                  thispage="#group#"
                  totalpages="#total_pages#"
                  link="#VAROOT#/listings/categories/index7.cfm?category=#category##pageLink#">
              </font>
            </center>
            <br>
            <!--- <font size=-1>
