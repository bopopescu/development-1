...
<cfif Attributes.part IS "HEADER">
  ...
  <tr>
    <td width=130 align=center valign=top><font size=2><b>Item</b></font></td>
	  <td width=85 align=center valign=top><font size=2><b>Start<br> Price</b></font></td>
      <td width=85 align=center valign=top><font size=2><b>Current<br> Price (#Trim(getCurrency.type)#)</b></font></td>
      <td width=20 align=center valign=top><font size=2><b>Qty</b></font></td>
	  <td width=40 align=center valign=top><font size=2><b>Bids</b></font></td>
 <td width=52 align=center valign=top><font size=2><a href="/messaging"><b>Buyers<br>Name</b></a></font></td>	
  <td width=52 align=center valign=top><font size=2><a href="/feedback/leavefeedback.cfm"><b>Feed<br>back</b></a></font></td>
      ...
      <td width=86 align=center valign=top><font size=2><b>End Date</b></font></td>
      <td width=86 align=center valign=top><font size=2><b>Relist</b></font></td>
...
select comment from feedback
   WHERE itemnum = #Attributes.itemnum# and user_id=#session.user_id#
or itemnum = #Attributes.itemnum# and user_id_from=#session.user_id#
...
<!---		 AND buynow = 0 --->
 ...
 <!---  <cfquery username="#db_username#" password="#db_password#" name="check_auction_cancel" datasource="#datasource#">
  ...
  <cfoutput>
  <!--- <cfif #Attributes.featured_studio# IS 1 and #Attributes.show_thumbs# IS 1>
     <tr#rowcolor#>#theThumb# 
	  <td width=206>&nbsp;#new_icon#<a href="#Attributes.VAROOT#/listings/details/index.cfm?itemnum=#Attributes.itemnum#">#boldstart##Trim(Attributes.itemtitle)##boldend#</a>#reverse##pht_icon##snd_icon#<cfif check_buynow.buynow eq 1>&nbsp;<img src="#VAROOT#/images/buynow.jpg" border="0"></cfif>#ban_info#</td>
	  <td width=80 align=right valign=middle>#startprice#</td>
	  <td width=80 align=right valign=middle>#price#</td>
	  <td width=50 align=center valign=middle>#bids#</td>
	  <td width=50 align=center valign=middle><a href="/feedback/leavefeedback.cfm"></td>
	  <td width=50 align=center valign=middle><a href="/feedback/leavefeedback.cfm"></td>
	  <td width=50 align=center valign=middle>#starts#</td>
...
<td width=50 align=center valign=middle><a href="mailto:#attributes.email#" target=_blank><font size=1>#attributes.bidder#</font></a></td>
<td width=50 align=center valign=middle>
<cfif #feedback.recordcount# eq 0>
<a href="#Attributes.VAROOT#/feedback/leavefeedback.cfm?user_id=#gethighbidder.user_id#&itemnum=#attributes.itemnum#" target=_blank><font size=1>Leave<br>feed<br>back</font></a>
<cfelse><font color=red size=1><b>
Feed<br>back<br>left</b></font></cfif>
</td>	<td width=80 align=center valign=middle>#started#</td>
	<td width=80 align=center valign=middle>#ends# CST</td>
	<td width=80 align=center valign=middle><a href="#attributes.VARoot#/personal/relist_info.cfm?itemnum=#attributes.itemnum#&submit=continue">#attributes.itemnum#</a></td>
