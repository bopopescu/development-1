...
alias startes='elasticsearch --config=/usr/local/opt/elasticsearch/config/elasticsearch.yml'
...
alias startms='$SCRIPTS_DIR/run-service.sh metadata-search-service'
...
alias killms='killps metadata-search-service'
